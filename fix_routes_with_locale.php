...
/**
 * Script pour ajouter le support des préfixes de langue dans les routes
 */
...
echo "✓ Fichier routes/web.php mis à jour avec succès!\n";
echo "✓ Les routes supportent maintenant les préfixes de langue (fr, en, de, nl, es, pl, it)\n";
echo "\nExemples d'URLs:\n";
echo "  - /fr/login\n";
echo "  - /en/register\n";
echo "  - /de/dashboard\n";
