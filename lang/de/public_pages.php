...
$data['shared'] = [
    ...
    'privacy_notice'=>'Ich akzeptiere, dass NEXALUNE BANK diese Informationen zur Beantwortung meiner Anfrage nutzt.','send_request'=>'Anfrage senden','rights'=>'Alle Rechte vorbehalten.',
];
$t = [
    ...
    'about_story'=>['Unsere Geschichte','Eine Bank, die Klarheit in digitale Finanzen bringt.','NEXALUNE BANK modernisiert Banking ohne Seriosität zu verlieren.','Mein Konto öffnen','Vertrauen, Klarheit und Sicherheit.','Entdecken Sie eine Bank mit Methode.'],
    ...
    'about_press'=>['Presse und Medien','Presseinformationen zur Entwicklung von NEXALUNE BANK.','Positionierung, Themen und offizielle Informationen.','Presse kontaktieren','Eine digitale Bank mit echtem Anspruch.','Benötigen Sie verlässliche Presseinformationen?'],
    ...
    'support_security'=>['Banksicherheit','Sicherheit muss in jedem Schritt sichtbar sein.','NEXALUNE BANK schützt Zugänge, sensible Vorgänge und überprüfbare Nachweise.','Sicheres Konto eröffnen','Sicherheit für reale Nutzung.','Sichern Sie Ihre Vorgänge mit sichtbaren Nachweisen.'],
    'support_legal'=>['Impressum','Ein verständlicher Rechtsrahmen für NEXALUNE BANK.','Informationen zu Betreiber, Nutzung, Daten und Verantwortung.','NEXALUNE BANK kontaktieren','Konformität beginnt mit verständlichen Informationen.','Fragen zum Rechtsrahmen?'],
];
