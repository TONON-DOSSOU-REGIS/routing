...
return [
    ...
    'titles' => [
        ...
        'admin_user_login' => 'Client interface login',
    ...
    'messages' => [
        ...
        'admin_user_login' => 'Client :user_name (:user_email) has just signed in to the dashboard. IP address: :ip_address. Detected browser: :user_agent.',
