...
$data['shared'] = [
    ...
    'privacy_notice'=>'I agree that NEXALUNE BANK may use this information to answer my request.','send_request'=>'Send my request','rights'=>'All rights reserved.',
];
$t = [
    ...
    'about_story'=>['Our story','A bank built to bring clarity back to digital finance.','NEXALUNE BANK modernizes banking without losing seriousness.','Open my space','Trust, clarity and security.','Discover a bank that moves forward with method.'],
    ...
    'about_press'=>['Press and media','Press resources to understand the evolution of NEXALUNE BANK.','Find our positioning, key topics and official information.','Contact press','A digital bank that takes seriousness seriously.','Need reliable press information?'],
    ...
    'support_security'=>['Banking security','Security should be visible at every step.','NEXALUNE BANK protects access, sensitive operations and verifiable proofs.','Open a secure account','Security designed for real use.','Secure your operations with visible proof.'],
    'support_legal'=>['Legal information','A readable legal framework to use NEXALUNE BANK with confidence.','Essential information about the publisher, site use, data and responsibilities.','Contact NEXALUNE BANK','Compliance starts with understandable information.','A question about legal information?'],
];
foreach ($t as $key => $v) {
