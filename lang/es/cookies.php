...
return [
    ...
    'preferences_title' => 'Centro de preferencias de privacidad',
    'preferences_intro' => 'Configure sus preferencias a continuación. Las cookies estrictamente necesarias no se pueden desactivar, ya que garantizan el funcionamiento y la seguridad del sitio.',
    'preferences_save' => 'Guardar mis preferencias',
    'preferences_accept_all' => 'Aceptar todo y cerrar',
    'preferences_close' => 'Cerrar',
    'preferences_updated_at' => 'Última actualización de sus preferencias',

    'category_necessary_title' => 'Cookies estrictamente necesarias',
    'category_necessary_text' => 'Imprescindibles para la navegación, la autenticación segura y la protección contra el fraude. El sitio no puede funcionar correctamente sin ellas.',
    'category_necessary_badge' => 'Siempre activas',

    'category_analytics_title' => 'Cookies analíticas y de medición de audiencia',
    'category_analytics_text' => 'Nos ayudan a comprender cómo se utiliza el sitio (páginas visitadas, tiempo de permanencia, recorrido de navegación) con el fin de mejorar nuestros servicios. Los datos se agregan y anonimizan.',

    'category_functional_title' => 'Cookies funcionales y de personalización',
    'category_functional_text' => 'Memorizan sus preferencias (idioma, divisa mostrada, disposición de la página) para ofrecerle una experiencia coherente entre una visita y otra.',

    'category_marketing_title' => 'Cookies de marketing y publicidad',
    ...
    'section_types_title' => 'Las categorías de cookies que utilizamos',
    ...
    'cookie_analytics_purpose' => 'Medición de audiencia anonimizada: páginas consultadas, duración de la visita, origen del tráfico.',
    'cookie_analytics_duration' => 'Hasta 13 meses',

    'cookie_marketing_name' => 'Cookies publicitarias de terceros',
    'cookie_marketing_purpose' => 'Personalización de las comunicaciones de marketing y medición de la eficacia de las campañas, sujeto a su consentimiento.',
    'cookie_marketing_duration' => 'Hasta 13 meses',

    'section_legal_basis_title' => 'Base legal y consentimiento',
    'section_legal_basis_text' => 'De conformidad con el Reglamento General de Protección de Datos (RGPD) y la Directiva ePrivacy, las cookies estrictamente necesarias para el funcionamiento del sitio se instalan sin consentimiento previo, sobre la base de nuestro interés legítimo en garantizar un servicio seguro. Todas las demás cookies (analíticas, funcionales, de marketing) solo se instalan tras haber obtenido su consentimiento explícito a través del banner previsto a tal efecto. Puede retirar este consentimiento en cualquier momento.',

    'section_rights_title' => 'Sus derechos y cómo ejercerlos',
    'section_rights_text' => 'Puede en cualquier momento aceptar, rechazar o modificar sus preferencias de cookies haciendo clic en el enlace «Gestionar mis cookies» presente en el pie de página de cada página del sitio. También puede configurar su navegador para bloquear o eliminar las cookies, teniendo en cuenta que esto puede afectar a determinadas funcionalidades del sitio, en particular las relacionadas con la seguridad de su cuenta. De conformidad con el RGPD, también dispone de un derecho de acceso, rectificación, supresión y portabilidad de sus datos personales, que puede ejercer poniéndose en contacto con nosotros a través de nuestro formulario de contacto.',

    'section_thirdparty_title' => 'Compartición con terceros',
    ...
    'section_contact_cta' => 'Contactar con nuestro equipo',

    'manage_preferences_link' => 'Gestionar mis cookies',
    'footer_link_label' => 'Política de cookies',
];
