...
return [
    ...
    'titles' => [
        ...
        'admin_user_login' => 'Acceso al espacio del cliente',
    ...
    'messages' => [
        ...
        'admin_user_login' => 'El cliente :user_name (:user_email) acaba de iniciar sesion en su espacio. Direccion IP: :ip_address. Navegador detectado: :user_agent.',
