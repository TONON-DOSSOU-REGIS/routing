...
$data['shared'] = [
    ...
    'privacy_notice'=>'Acepto que NEXALUNE BANK use esta información para responder a mi solicitud.','send_request'=>'Enviar mi solicitud','rights'=>'Todos los derechos reservados.',
];
$t = [
    ...
    'about_story'=>['Nuestra historia','Un banco creado para devolver claridad a la finanza digital.','NEXALUNE BANK moderniza la banca sin perder seriedad.','Abrir mi espacio','Confianza, claridad y seguridad.','Descubra un banco que avanza con método.'],
    ...
    'about_press'=>['Prensa y medios','Recursos de prensa para entender la evolución de NEXALUNE BANK.','Encuentre nuestro posicionamiento, temas clave e información oficial.','Contactar prensa','Un banco digital que asume su seriedad.','¿Necesita información de prensa fiable?'],
    ...
    'support_security'=>['Seguridad bancaria','La seguridad debe verse en cada etapa.','NEXALUNE BANK protege accesos, operaciones sensibles y pruebas verificables.','Abrir una cuenta segura','Seguridad pensada para el uso real.','Proteja sus operaciones con pruebas visibles.'],
    'support_legal'=>['Aviso legal','Un marco legal legible para usar NEXALUNE BANK con confianza.','Información esencial sobre editor, uso, datos y responsabilidades.','Contactar NEXALUNE BANK','El cumplimiento empieza con información comprensible.','¿Pregunta sobre el marco legal?'],
];
