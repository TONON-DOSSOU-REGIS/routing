...
return [
    'page_title' => 'Nouveau virement - NEXALUNE BANK',
    ...
    'activation_code_admin_help' => 'Saisissez le code à usage unique défini par votre administrateur.',
    'activation_code_not_configured' => 'Aucun code d\'activation n\'a été configuré pour votre compte. Contactez votre administrateur.',
    'transfer_already_pending' => 'Un virement est déjà en cours. Attendez sa finalisation avant d\'en démarrer un autre.',
    'send_activation_code' => 'Recevoir le code par e-mail',
    'sending_activation_code' => 'Envoi du code...',
    'resend_activation_code' => 'Renvoyer le code',
    'activation_code_sent' => 'Un code à 6 chiffres a été envoyé à :email. Il est valable 10 minutes.',
    'activation_email_failed' => 'Le code n\'a pas pu être envoyé. Veuillez réessayer.',
    'activation_code_expired' => 'Le code est absent ou expiré. Demandez un nouveau code.',
    'activation_too_many_attempts' => 'Trop de codes incorrects. Réessayez dans 15 minutes.',
    'activation_details_changed' => 'Les informations du virement ont changé. Demandez un nouveau code.',
    'activation_email_subject' => 'Votre code de confirmation de virement',
    'activation_email_title' => 'Confirmez votre virement',
    'activation_email_greeting' => 'Bonjour :name,',
    'activation_email_body' => 'Saisissez le code ci-dessous dans votre espace client pour autoriser le démarrage du virement.',
    'activation_email_expiry' => 'Ce code personnel expire dans :minutes minutes.',
    'activation_email_security' => 'Ne communiquez jamais ce code. Si vous n\'êtes pas à l\'origine de cette demande, ignorez cet e-mail.',
    'activation_email_preheader' => 'Votre code sécurisé est valable :minutes minutes.',
    'activation_email_secure_badge' => 'Vérification sécurisée',
    'activation_email_eyebrow' => 'Autorisation de virement',
    'activation_email_summary_title' => 'Virement à confirmer',
    'activation_email_instruction_title' => 'Comment confirmer votre opération',
    'activation_email_instruction' => 'Retournez dans votre espace client, saisissez ce code dans le champ prévu, puis lancez le virement. Aucun débit ne sera effectué avant cette confirmation.',
    'activation_email_security_title' => 'Votre sécurité avant tout',
    'activation_email_footer' => 'Ce message automatique a été envoyé dans le cadre d\'une demande de virement depuis votre espace client sécurisé.',
    'activation_email_footer_notice' => 'Ne répondez pas à cet e-mail. © :year NEXALUNE BANK. Tous droits réservés.',
    'cancel' => 'Annuler',
    ...
    'resume_code_title' => 'Code de reprise sécurisé',
    'resume_code_help' => 'Saisissez le nouveau code à 6 caractères transmis par votre administrateur de la banque. Le même virement reprendra exactement à son pourcentage actuel.',
    'resume_code_placeholder' => 'Ex. A1B2C3',
    'resume_transfer' => 'Reprendre le virement',
    'resuming_transfer' => 'Vérification du code...',
    'resume_success' => 'Code validé. Le virement reprend à :percentage %.',
    'resume_not_on_hold' => 'Ce virement n’est plus en attente d’un code de reprise.',
    'resume_code_not_configured' => 'Aucun nouveau code de reprise n’a encore été configuré. Contactez votre administrateur.',
    'resume_percentage_must_increase' => 'Le prochain pourcentage doit être supérieur à la progression actuelle de :percentage %. Contactez votre administrateur.',
    'transfer_rule_not_configured' => 'Aucun pourcentage de progression valide n’a été configuré pour votre compte. Contactez votre administrateur.',
    ...
    'history_page_title' => 'Historique des transactions - NEXALUNE BANK',
    ...
    'receipt_page_title' => 'Reçu de transaction - NEXALUNE BANK',
    'receipt_title' => 'Reçu',
    ...
    'transfer_receipt_email_subject' => 'Reçu officiel de virement #:id - NEXALUNE BANK',
    ...
    'transfer_receipt_email_footer_intro' => 'Cet e-mail a été émis automatiquement par NEXALUNE BANK après l\'exécution complète de votre virement.',
    ...
    'transfer_receipt_email_footer_notice' => 'Ne répondez pas directement à cet e-mail. © :year NEXALUNE BANK. Tous droits réservés.',
];
