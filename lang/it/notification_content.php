...
return [
    ...
    'titles' => [
        ...
        'admin_user_login' => 'Accesso all area cliente',
    ...
    'messages' => [
        ...
        'admin_user_login' => "Il cliente :user_name (:user_email) ha appena effettuato l'accesso alla propria area. Indirizzo IP: :ip_address. Browser rilevato: :user_agent.",
