...
$data['shared'] = [
    ...
    'privacy_notice'=>'Accetto che NEXALUNE BANK utilizzi queste informazioni per rispondere alla mia richiesta.','send_request'=>'Invia la richiesta','rights'=>'Tutti i diritti riservati.',
];
$t = [
    ...
    'about_story'=>['La nostra storia','Una banca creata per riportare chiarezza nella finanza digitale.','NEXALUNE BANK modernizza la banca senza perdere serietà.','Apri il mio spazio','Fiducia, chiarezza e sicurezza.','Scopri una banca che avanza con metodo.'],
    ...
    'about_press'=>['Stampa e media','Risorse stampa per capire l’evoluzione di NEXALUNE BANK.','Trova posizionamento, temi chiave e informazioni ufficiali.','Contatta la stampa','Una banca digitale che assume la propria serietà.','Hai bisogno di informazioni stampa affidabili?'],
    ...
    'support_security'=>['Sicurezza bancaria','La sicurezza deve essere visibile in ogni passaggio.','NEXALUNE BANK protegge accessi, operazioni sensibili e prove verificabili.','Apri un conto sicuro','Sicurezza pensata per l’uso reale.','Proteggi le operazioni con prove visibili.'],
    'support_legal'=>['Note legali','Un quadro legale leggibile per usare NEXALUNE BANK con fiducia.','Informazioni essenziali su editore, uso del sito, dati e responsabilità.','Contatta NEXALUNE BANK','La conformità inizia da informazioni comprensibili.','Domande sul quadro legale?'],
];
