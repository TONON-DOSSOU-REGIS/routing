...
return [
    ...
    // Personalisatiepaneel
    'preferences_title' => 'Privacyvoorkeurencentrum',
    'preferences_intro' => 'Stel hieronder uw voorkeuren in. Strikt noodzakelijke cookies kunnen niet worden uitgeschakeld, aangezien zij de werking en de veiligheid van de website garanderen.',
    'preferences_save' => 'Mijn voorkeuren opslaan',
    'preferences_accept_all' => 'Alles accepteren en sluiten',
    'preferences_close' => 'Sluiten',
    'preferences_updated_at' => 'Laatste update van uw voorkeuren',

    'category_necessary_title' => 'Strikt noodzakelijke cookies',
    'category_necessary_text' => 'Onmisbaar voor de navigatie, veilige authenticatie en bescherming tegen fraude. De website kan zonder deze cookies niet naar behoren functioneren.',
    'category_necessary_badge' => 'Altijd actief',

    'category_analytics_title' => 'Analytische en publieksmetende cookies',
    'category_analytics_text' => 'Helpen ons begrijpen hoe de website wordt gebruikt (bezochte pagina\'s, tijd besteed, navigatiepad) om onze diensten te verbeteren. De gegevens worden geaggregeerd en geanonimiseerd.',

    'category_functional_title' => 'Functionele en personalisatiecookies',
    'category_functional_text' => 'Onthouden uw voorkeuren (taal, weergegeven valuta, lay-out) om u van bezoek tot bezoek een consistente ervaring te bieden.',

    'category_marketing_title' => 'Marketing- en advertentiecookies',
    ...
    'section_types_title' => 'De categorieën cookies die wij gebruiken',
    ...
    'cookie_analytics_purpose' => 'Geanonimiseerde publieksmeting: geraadpleegde pagina\'s, bezoekduur, herkomst van het verkeer.',
    'cookie_analytics_duration' => 'Tot 13 maanden',

    'cookie_marketing_name' => 'Advertentiecookies van derden',
    'cookie_marketing_purpose' => 'Personalisatie van marketingcommunicatie en meting van de doeltreffendheid van campagnes, onder voorbehoud van uw toestemming.',
    'cookie_marketing_duration' => 'Tot 13 maanden',

    'section_legal_basis_title' => 'Rechtsgrondslag en toestemming',
    'section_legal_basis_text' => 'Overeenkomstig de Algemene Verordening Gegevensbescherming (AVG) en de ePrivacy-richtlijn worden cookies die strikt noodzakelijk zijn voor de werking van de website geplaatst zonder voorafgaande toestemming, op basis van ons gerechtvaardigd belang om een veilige dienst te waarborgen. Alle andere cookies (analytisch, functioneel, marketing) worden pas geplaatst nadat uw uitdrukkelijke toestemming is verkregen via de daarvoor bestemde banner. U kunt deze toestemming te allen tijde intrekken.',

    'section_rights_title' => 'Uw rechten en hoe u deze kunt uitoefenen',
    'section_rights_text' => 'U kunt op elk moment uw cookievoorkeuren aanvaarden, weigeren of wijzigen door te klikken op de link "Mijn cookies beheren" onderaan elke pagina van de website. U kunt uw browser ook zo instellen dat cookies worden geblokkeerd of verwijderd, met dien verstande dat dit bepaalde functionaliteiten van de website kan beïnvloeden, met name die welke verband houden met de veiligheid van uw rekening. Overeenkomstig de AVG beschikt u tevens over een recht op inzage, rectificatie, verwijdering en overdraagbaarheid van uw persoonsgegevens, dat u kunt uitoefenen door contact met ons op te nemen via ons contactformulier.',

    'section_thirdparty_title' => 'Delen met derden',
    ...
    'section_contact_cta' => 'Neem contact op met ons team',

    'manage_preferences_link' => 'Mijn cookies beheren',
    'footer_link_label' => 'Cookiebeleid',
];
