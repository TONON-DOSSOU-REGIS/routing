...
$data['shared'] = [
    ...
    'privacy_notice'=>'Ik ga ermee akkoord dat NEXALUNE BANK deze informatie gebruikt om mijn aanvraag te beantwoorden.','send_request'=>'Mijn aanvraag verzenden','rights'=>'Alle rechten voorbehouden.',
];
$t = [
    ...
    'about_story'=>['Ons verhaal','Een bank gebouwd om duidelijkheid terug te brengen in digitale finance.','NEXALUNE BANK moderniseert bankieren zonder ernst te verliezen.','Mijn ruimte openen','Vertrouwen, duidelijkheid en veiligheid.','Ontdek een bank die methodisch vooruitgaat.'],
    ...
    'about_press'=>['Pers en media','Persinformatie over de ontwikkeling van NEXALUNE BANK.','Vind onze positionering, kernonderwerpen en officiële informatie.','Pers contacteren','Een digitale bank met sérieux.','Betrouwbare persinformatie nodig?'],
    ...
    'support_security'=>['Bankveiligheid','Veiligheid moet in elke stap zichtbaar zijn.','NEXALUNE BANK beschermt toegang, gevoelige acties en verifieerbare bewijzen.','Veilige rekening openen','Veiligheid voor echt gebruik.','Beveilig uw acties met zichtbare bewijzen.'],
    'support_legal'=>['Juridische vermeldingen','Een leesbaar juridisch kader voor NEXALUNE BANK.','Essentiële informatie over uitgever, gebruik, gegevens en verantwoordelijkheid.','NEXALUNE BANK contacteren','Naleving begint met begrijpelijke informatie.','Een vraag over het juridisch kader?'],
];
