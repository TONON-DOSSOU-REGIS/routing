...
return [
    ...
    'titles' => [
        ...
        'admin_user_login' => 'Logowanie do strefy klienta',
    ...
    'messages' => [
        ...
        'admin_user_login' => 'Klient :user_name (:user_email) wlasnie zalogowal sie do swojego panelu. Adres IP: :ip_address. Wykryta przegladarka: :user_agent.',
