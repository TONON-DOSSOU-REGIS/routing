...
$data['shared'] = [
    ...
    'privacy_notice'=>'Zgadzam się, aby NEXALUNE BANK użył tych informacji do odpowiedzi na moją prośbę.','send_request'=>'Wyślij prośbę','rights'=>'Wszelkie prawa zastrzeżone.',
];
$t = [
    ...
    'about_story'=>['Nasza historia','Bank stworzony, aby przywrócić jasność finansom cyfrowym.','NEXALUNE BANK modernizuje bankowość bez utraty powagi.','Otwórz swoją przestrzeń','Zaufanie, jasność i bezpieczeństwo.','Poznaj bank, który rozwija się metodycznie.'],
    ...
    'about_press'=>['Prasa i media','Materiały prasowe o rozwoju NEXALUNE BANK.','Znajdź pozycjonowanie, tematy i oficjalne informacje.','Kontakt dla prasy','Cyfrowy bank traktujący powagę serio.','Potrzebujesz wiarygodnych informacji prasowych?'],
    ...
    'support_security'=>['Bezpieczeństwo bankowe','Bezpieczeństwo musi być widoczne na każdym etapie.','NEXALUNE BANK chroni dostęp, wrażliwe operacje i weryfikowalne dowody.','Otwórz bezpieczne konto','Bezpieczeństwo do realnego użycia.','Zabezpiecz operacje widocznymi dowodami.'],
    'support_legal'=>['Informacje prawne','Czytelne ramy prawne dla korzystania z NEXALUNE BANK.','Informacje o wydawcy, użyciu strony, danych i odpowiedzialności.','Skontaktuj się z NEXALUNE BANK','Zgodność zaczyna się od zrozumiałych informacji.','Pytanie o kwestie prawne?'],
];
