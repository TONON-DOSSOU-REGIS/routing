    ...
    $translations = [
        'en' => [
            ...
            'faq' => [
                ...
                ['question' => 'Is the information kept up to date?', 'answer' => 'Yes. Content evolves with the services and the NEXALUNE BANK experience.'],
            ...
            'cta_text' => 'Move to a clearer, more modern and better structured banking experience with NEXALUNE BANK.',
            ...
            'contact' => ['kicker' => 'Secure form', 'title' => 'Send your request to NEXALUNE BANK.', 'intro' => 'The form keeps fields compatible with the existing handling process.', 'cards' => [['icon' => 'fas fa-envelope', 'title' => 'Support email', 'text' => 'support@nexalunebank.com for general requests.'], ['icon' => 'fas fa-building', 'title' => 'Business requests', 'text' => 'Accounts, cards, treasury or banking operations.']]],
            'legal_items' => [['title' => 'Website publisher', 'text' => 'The website is published by NEXALUNE BANK.'], ['title' => 'Purpose of the website', 'text' => 'The website presents NEXALUNE BANK digital banking services.'], ['title' => 'Personal data', 'text' => 'Data is used to manage accounts, secure access and process requests.']],
        ],
        'de' => [
            ...
            'faq' => [
                ...
                ['question' => 'Werden die Informationen aktualisiert?', 'answer' => 'Ja. Die Inhalte entwickeln sich mit den Services und der Erfahrung von NEXALUNE BANK weiter.'],
            ...
            'cta_text' => 'Wechseln Sie zu einem klareren, moderneren und besser strukturierten Bankerlebnis mit NEXALUNE BANK.',
            ...
            'contact' => ['kicker' => 'Sicheres Formular', 'title' => 'Senden Sie Ihre Anfrage an NEXALUNE BANK.', 'intro' => 'Das Formular behält Felder bei, die mit der bestehenden Bearbeitung kompatibel sind.', 'cards' => [['icon' => 'fas fa-envelope', 'title' => 'Support-E-Mail', 'text' => 'support@nexalunebank.com für allgemeine Anfragen.'], ['icon' => 'fas fa-building', 'title' => 'Geschäftsanfragen', 'text' => 'Konten, Karten, Treasury oder Bankgeschäfte.']]],
            'legal_items' => [['title' => 'Herausgeber der Website', 'text' => 'Die Website wird von NEXALUNE BANK herausgegeben.'], ['title' => 'Zweck der Website', 'text' => 'Die Website präsentiert die digitalen Bankdienstleistungen von NEXALUNE BANK.'], ['title' => 'Personenbezogene Daten', 'text' => 'Daten werden zur Kontoverwaltung, Zugangssicherung und Bearbeitung von Anfragen verwendet.']],
        ],
        'nl' => [
            ...
            'faq' => [
                ...
                ['question' => 'Wordt de informatie bijgewerkt?', 'answer' => 'Ja. De inhoud evolueert met de diensten en de ervaring van NEXALUNE BANK.'],
            ...
            'cta_text' => 'Stap over naar een duidelijkere, modernere en beter gestructureerde bankervaring met NEXALUNE BANK.',
            ...
            'contact' => ['kicker' => 'Beveiligd formulier', 'title' => 'Stuur uw aanvraag naar NEXALUNE BANK.', 'intro' => 'Het formulier behoudt velden die compatibel zijn met de bestaande verwerking.', 'cards' => [['icon' => 'fas fa-envelope', 'title' => 'Support e-mail', 'text' => 'support@nexalunebank.com voor algemene aanvragen.'], ['icon' => 'fas fa-building', 'title' => 'Professionele aanvragen', 'text' => 'Rekeningen, kaarten, treasury of bankverrichtingen.']]],
            'legal_items' => [['title' => 'Uitgever van de website', 'text' => 'De website wordt uitgegeven door NEXALUNE BANK.'], ['title' => 'Doel van de website', 'text' => 'De website presenteert de digitale bankdiensten van NEXALUNE BANK.'], ['title' => 'Persoonsgegevens', 'text' => 'Gegevens worden gebruikt om rekeningen te beheren, toegang te beveiligen en aanvragen te verwerken.']],
        ],
        'es' => [
            ...
            'faq' => [
                ...
                ['question' => '¿La información se actualiza?', 'answer' => 'Sí. Los contenidos evolucionan con los servicios y la experiencia NEXALUNE BANK.'],
            ...
            'cta_text' => 'Pase a una experiencia bancaria más clara, moderna y mejor estructurada con NEXALUNE BANK.',
            ...
            'contact' => ['kicker' => 'Formulario seguro', 'title' => 'Envíe su solicitud a NEXALUNE BANK.', 'intro' => 'El formulario conserva campos compatibles con el tratamiento existente.', 'cards' => [['icon' => 'fas fa-envelope', 'title' => 'Email de soporte', 'text' => 'support@nexalunebank.com para solicitudes generales.'], ['icon' => 'fas fa-building', 'title' => 'Solicitudes profesionales', 'text' => 'Cuentas, tarjetas, tesorería u operaciones bancarias.']]],
            'legal_items' => [['title' => 'Editor del sitio', 'text' => 'El sitio es editado por NEXALUNE BANK.'], ['title' => 'Objeto del sitio', 'text' => 'El sitio presenta los servicios bancarios digitales de NEXALUNE BANK.'], ['title' => 'Datos personales', 'text' => 'Los datos sirven para gestionar cuentas, proteger accesos y tratar solicitudes.']],
        ],
        'pl' => [
            ...
            'faq' => [
                ...
                ['question' => 'Czy informacje są aktualizowane?', 'answer' => 'Tak. Treści rozwijają się wraz z usługami i doświadczeniem NEXALUNE BANK.'],
            ...
            'cta_text' => 'Przejdź na jaśniejsze, nowocześniejsze i lepiej uporządkowane doświadczenie bankowe z NEXALUNE BANK.',
            ...
            'contact' => ['kicker' => 'Bezpieczny formularz', 'title' => 'Wyślij zgłoszenie do NEXALUNE BANK.', 'intro' => 'Formularz zachowuje pola zgodne z obecnym procesem obsługi.', 'cards' => [['icon' => 'fas fa-envelope', 'title' => 'Email wsparcia', 'text' => 'support@nexalunebank.com dla ogólnych zapytań.'], ['icon' => 'fas fa-building', 'title' => 'Zapytania biznesowe', 'text' => 'Konta, karty, treasury lub operacje bankowe.']]],
            'legal_items' => [['title' => 'Wydawca strony', 'text' => 'Strona jest wydawana przez NEXALUNE BANK.'], ['title' => 'Cel strony', 'text' => 'Strona prezentuje cyfrowe usługi bankowe NEXALUNE BANK.'], ['title' => 'Dane osobowe', 'text' => 'Dane służą do zarządzania kontami, zabezpieczania dostępu i obsługi zgłoszeń.']],
        ],
        'it' => [
            ...
            'faq' => [
                ...
                ['question' => 'Le informazioni sono aggiornate?', 'answer' => 'Sì. I contenuti evolvono con i servizi e l’esperienza NEXALUNE BANK.'],
            ...
            'cta_text' => 'Passa a un’esperienza bancaria più chiara, moderna e meglio strutturata con NEXALUNE BANK.',
            ...
            'contact' => ['kicker' => 'Modulo sicuro', 'title' => 'Invia la tua richiesta a NEXALUNE BANK.', 'intro' => 'Il modulo conserva campi compatibili con il processo di gestione esistente.', 'cards' => [['icon' => 'fas fa-envelope', 'title' => 'Email supporto', 'text' => 'support@nexalunebank.com per richieste generali.'], ['icon' => 'fas fa-building', 'title' => 'Richieste professionali', 'text' => 'Conti, carte, tesoreria o operazioni bancarie.']]],
            'legal_items' => [['title' => 'Editore del sito', 'text' => 'Il sito è pubblicato da NEXALUNE BANK.'], ['title' => 'Oggetto del sito', 'text' => 'Il sito presenta i servizi bancari digitali di NEXALUNE BANK.'], ['title' => 'Dati personali', 'text' => 'I dati servono a gestire conti, proteggere accessi e trattare richieste.']],
        ],
    ];
