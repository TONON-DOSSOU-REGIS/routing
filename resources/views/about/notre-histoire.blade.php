...
<head>
    ...
    <title>Notre histoire - BankPro</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto fade-in-up">
                ...
                <p class="text-xl mb-8 text-blue-100 leading-relaxed">
                    Depuis 2018, BankPro révolutionne la banque en ligne pour les professionnels
    ...
    <section class="py-24 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-4xl font-bold mb-6 text-premium">L'évolution de BankPro</h2>
                ...
                <div class="timeline-item">
                    ...
                    <div class="premium-card rounded-2xl p-8">
                        <div class="flex flex-col md:flex-row md:items-center md:space-x-6">
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-bold mb-3 text-premium">Naissance de BankPro</h3>
                                <p class="text-gray-600 leading-relaxed mb-4">
                                    Création de BankPro par une équipe d'experts en finance et technologie.
                    ...
                    <div class="premium-card rounded-2xl p-8 border-2 border-blue-200">
                        <div class="flex flex-col md:flex-row md:items-center md:space-x-6">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 leading-relaxed mb-4">
                                    BankPro continue d'innover pour offrir la meilleure expérience bancaire digitale
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-4xl font-bold mb-6 text-premium">L'équipe BankPro</h2>
                <p class="text-xl text-gray-600 leading-relaxed">
    ...
    <section class="py-24 bg-gradient-to-r from-blue-900 to-blue-800 text-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl font-bold mb-6">Rejoignez l'aventure BankPro</h2>
            <p class="text-xl mb-8 text-blue-100 leading-relaxed">
