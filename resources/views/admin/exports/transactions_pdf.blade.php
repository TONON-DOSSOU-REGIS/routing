            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="user-name">{{ $transaction->user->first_name }} {{ $transaction->user->last_name }}</td>
                        <td>
                            <span class="type-badge type-{{ $transaction->type }}">
                                {{ $transaction->type }}
                            </span>
                        </td>
                        <td class="amount {{ $transaction->type == 'deposit' ? 'amount-positive' : 'amount-negative' }}">
                            ...
                            <div class="progress-container">
                                <div class="progress-bar">
                                    <div class="progress-fill 
                                        @if($transaction->progress >= 100) progress-100
                                        @elseif($transaction->progress >= 70) progress-70
                                        @elseif($transaction->progress >= 50) progress-50
                                        @else progress-30 @endif"
                        ...
                        <td class="date-cell">{{ $transaction->created_at->format('d/m/Y H:i') }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
