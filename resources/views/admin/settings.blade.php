...
<head>
    ...
    <title>Paramètres de progression - Valtrix Bank Admin</title>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden md:flex items-center space-x-6">
                            ...
                            <a href="{{ localized_route('admin.settings') }}" class="relative text-blue-600 font-semibold transition duration-300 group">
                    ...
                    <div class="md:hidden hidden" id="mobile-menu">
                        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white/95 backdrop-blur-lg border border-gray-200 rounded-lg shadow-xl mt-2">
                            ...
                            <a href="{{ localized_route('admin.settings') }}" class="flex items-center px-3 py-3 text-base font-medium text-blue-600 bg-blue-50 rounded-lg transition duration-300">
                    ...
                    <div class="lg:col-span-2">
                        <div class="glass-card rounded-2xl overflow-hidden card-hover">
                            <div class="px-4 sm:px-8 py-6 sm:py-8">
                                ...
                                <form method="POST" action="{{ localized_route('admin.settings.save') }}" class="space-y-6">
                                    @csrf
