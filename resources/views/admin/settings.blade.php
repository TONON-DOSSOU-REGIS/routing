                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden md:flex items-center space-x-6">
                            <a href="{{ route('admin.dashboard') }}" class="relative text-gray-700 hover:text-blue-600 transition duration-300 font-medium group">
                                <i class="fas fa-tachometer-alt mr-2"></i> Dashboard
                                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                            </a>
                            <a href="{{ route('admin.settings') }}" class="relative text-blue-600 font-semibold transition duration-300 group">
                    ...
                    <div class="md:hidden hidden" id="mobile-menu">
                        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white/95 backdrop-blur-lg border border-gray-200 rounded-lg shadow-xl mt-2">
                            ...
                            <a href="{{ route('admin.settings') }}" class="flex items-center px-3 py-3 text-base font-medium text-blue-600 bg-blue-50 rounded-lg transition duration-300">
                            ...
                            <div class="px-8 py-8">
                                ...
                                <form method="POST" action="{{ route('admin.settings.save') }}" class="space-y-6">
                                    ...
                                    <div class="stagger-item">
                                        ...
                                        <div class="mt-3">
                                            <div class="flex justify-between text-sm text-gray-600 mb-1">
                                                <span>0%</span>
                                                <span id="percentage-value">{{ old('stop_percentage', $settings->stop_percentage ?? 70) }}%</span>
                                                <span>100%</span>
                                            </div>
                                            <div class="w-full bg-gray-200 rounded-full h-2">
                                                <div id="percentage-bar" class="bg-gradient-to-r from-blue-500 to-indigo-600 h-2 rounded-full transition-all duration-300" 
                                                     style="width: {{ old('stop_percentage', $settings->stop_percentage ?? 70) }}%"></div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="text-sm text-blue-700 space-y-2">
                                                        <p class="flex items-center">
                                                            ...
                                                            <span class="ml-1">{{ $settings->stop_percentage ?? 70 }}%</span>
                                                        </p>
                                                        <p class="flex items-center">
                                                            <i class="fas fa-comment w-4 mr-2"></i>
                                                            <strong>Message :</strong> 
                                                            <span class="ml-1">{{ $settings->stop_message ?? 'Transaction suspendue pour vérification de sécurité.' }}</span>
                                                        </p>
                                                        <p class="flex items-center">
                                                            <i class="fas fa-globe w-4 mr-2"></i>
                                                            <strong>Portée :</strong> 
                                                            <span class="ml-1">{{ ($settings->is_global ?? true) ? 'Globale' : 'Spécifique' }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="stagger-item flex justify-end space-x-4 pt-4">
                                        <a href="{{ route('admin.dashboard') }}" class="bg-gray-100 text-gray-700 px-6 py-3 rounded-xl hover:bg-gray-200 transition duration-300 font-medium shadow-sm">
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p id="preview-message" class="text-sm text-amber-700">
                                                    {{ old('stop_message', $settings->stop_message ?? 'Transaction suspendue pour vérification de sécurité.') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-gradient-to-r from-gray-50 to-slate-50 border border-gray-200 rounded-xl p-4">
                                        <div class="text-center">
                                            ...
                                            <p class="text-xs text-gray-600">
                                                Le virement s'arrêtera à <span id="preview-percentage" class="font-bold">{{ old('stop_percentage', $settings->stop_percentage ?? 70) }}%</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
