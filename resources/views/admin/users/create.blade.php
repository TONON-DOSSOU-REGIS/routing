                ...
                <section class="admin-section rounded-[24px] p-5">
                    ...
                    <div class="mt-5 grid gap-4 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2">
                            <label for="activation_code" class="mb-2 block text-xs font-semibold uppercase tracking-[0.16em] text-slate-400">{{ __('admin_pages.activation_code') }}</label>
                            ...
                            <p class="mt-2 text-sm text-slate-500">{{ __('admin_pages.activation_code_create_help') }}</p>
                        </div>
                    </div>
                </section>
