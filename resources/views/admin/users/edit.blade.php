                ...
                <div class="mt-6 space-y-6">
                    ...
                    <section class="admin-section rounded-[24px] p-5">
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            <div>
                                <h4 class="text-lg font-semibold text-slate-950">{{ __('admin_pages.activation_code') }}</h4>
                                <p class="mt-1 text-sm text-slate-500">{{ __('admin_pages.activation_code_edit_help') }}</p>
                            </div>
                            <span class="rounded-full px-3 py-1 text-xs font-semibold {{ $hasActivationCode ? 'bg-emerald-50 text-emerald-700' : 'bg-amber-50 text-amber-700' }}">
                                {{ $hasActivationCode ? __('admin_pages.activation_code_configured') : __('admin_pages.activation_code_missing') }}
                            </span>
                        </div>
                        <div class="mt-5">
