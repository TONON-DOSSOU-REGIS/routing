...
@section('auth_nav_subtitle', __('auth_ui.client_access'))
...
@section('auth_hero')
    ...
    <div class="mt-10 grid gap-3 sm:grid-cols-3">
        <div class="auth-stat-card">
            ...
            <p class="mt-2 text-sm leading-6 text-white/74">{{ __('auth_ui.login_security_text') }}</p>
        </div>
        <div class="auth-stat-card">
            <p>{{ __('auth.login_feature_notifications') }}</p>
            <div class="mt-3 text-lg font-semibold text-white">Instant</div>
            <p class="mt-2 text-sm leading-6 text-white/74">{{ __('auth_ui.login_notifications_text') }}</p>
        </div>
        <div class="auth-stat-card">
            <p>{{ __('auth.login_feature_analytics') }}</p>
            <div class="mt-3 text-lg font-semibold text-white">Premium</div>
            <p class="mt-2 text-sm leading-6 text-white/74">{{ __('auth_ui.login_analytics_text') }}</p>
        </div>
    </div>
@endsection
...
@section('auth_panel')
    ...
    <div class="mt-6 rounded-[24px] bg-slate-50 px-4 py-4 ring-1 ring-slate-200/70">
        ...
        <p class="mt-2 text-sm leading-6 text-slate-500">{{ __('auth_ui.opening_premium_text') }}</p>
