...
<!-- Hero background -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex items-center space-x-2">
          ...
          <a href="{{ localized_route('home', ['locale' => app()->getLocale()]) }}" class="text-xl font-semibold text-slate-800 hover:text-blue-700 transition"><span class="sr-only">NEXALUNE BANK</span></a>
        </div>
  ...
  <footer class="mt-auto text-center text-slate-200 py-6 bg-black/40 backdrop-blur-sm">
    <div class="max-w-7xl mx-auto px-4">
      <p>&copy; {{ date('Y') }} <span class="text-blue-300 font-semibold">NEXALUNE BANK</span>. {{ __('auth.footer_copyright') }}</p>
