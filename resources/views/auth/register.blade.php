    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        ...
        <div class="hidden md:flex items-center space-x-4">
          ...
          <a href="{{ route('login') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300 btn-hover">Connexion</a>
        </div>
        <!-- Mobile menu -->
      ...
      <div id="mobile-menu" class="hidden pb-4 md:hidden">
        ...
        <a href="{{ route('login') }}" class="block px-2 py-1 bg-blue-600 text-white rounded-lg mt-2 btn-hover">Connexion</a>
      </div>
    </div>
  </nav>
      ...
      <form class="space-y-6" method="POST" action="{{ route('register') }}">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 stagger-item">
          <div>
            ...
            <div class="relative">
              ...
              <input id="first_name" name="first_name" type="text" required class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field" placeholder="Jean" value="{{ old('first_name') }}">
            </div>
          </div>
          <div>
            ...
            <div class="relative">
              <i class="fas fa-user absolute left-3 top-2.5 text-gray-400"></i>
              <input id="last_name" name="last_name" type="text" required class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field" placeholder="Dupont" value="{{ old('last_name') }}">
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 stagger-item">
          <div>
            ...
            <div class="relative">
              ...
              <input id="email" name="email" type="email" required class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field" placeholder="exemple@mail.com" value="{{ old('email') }}">
            </div>
          </div>
          <div>
            ...
            <div class="relative">
              ...
              <input id="phone" name="phone" type="text" class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field" placeholder="+33 6 45 78 90 12" value="{{ old('phone') }}">
            </div>
          </div>
        </div>
        ...
        <div class="stagger-item">
          ...
          <div class="relative">
            ...
            <input id="address" name="address" type="text" class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field" placeholder="12 rue Victor Hugo, Paris" value="{{ old('address') }}">
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 stagger-item">
          <div>
            ...
            <div class="relative">
              ...
              <select id="country" name="country" class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field">
                ...
                <option value="Norvège" {{ old('country') == 'Norvège' ? 'selected' : '' }}>(NO) Norvège</option>
                <option value="Islande" {{ old('country') == 'Islande' ? 'selected' : '' }}>(IS) Islande</option>
                <option value="Royaume-Uni" {{ old('country') == 'Royaume-Uni' ? 'selected' : '' }}>(GB) Royaume-Uni</option>
                <option value="Albanie" {{ old('country') == 'Albanie' ? 'selected' : '' }}>(AL) Albanie</option>
                <option value="Bosnie-Herzégovine" {{ old('country') == 'Bosnie-Herzégovine' ? 'selected' : '' }}>(BA) Bosnie-Herzégovine</option>
                <option value="Serbie" {{ old('country') == 'Serbie' ? 'selected' : '' }}>(RS) Serbie</option>
                <option value="Monténégro" {{ old('country') == 'Monténégro' ? 'selected' : '' }}>(ME) Monténégro</option>
                <option value="Macédoine du Nord" {{ old('country') == 'Macédoine du Nord' ? 'selected' : '' }}>(MK) Macédoine du Nord</option>
                <option value="Kosovo" {{ old('country') == 'Kosovo' ? 'selected' : '' }}>(XK) Kosovo</option>
                <option value="Andorre" {{ old('country') == 'Andorre' ? 'selected' : '' }}>(AD) Andorre</option>
                <option value="Liechtenstein" {{ old('country') == 'Liechtenstein' ? 'selected' : '' }}>(LI) Liechtenstein</option>
                <option value="Monaco" {{ old('country') == 'Monaco' ? 'selected' : '' }}>(MC) Monaco</option>
                <option value="Saint-Marin" {{ old('country') == 'Saint-Marin' ? 'selected' : '' }}>(SM) Saint-Marin</option>
                <option value="Vatican" {{ old('country') == 'Vatican' ? 'selected' : '' }}>(VA) Vatican</option>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input id="city" name="city" type="text" class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field" placeholder="Paris" value="{{ old('city') }}">
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 stagger-item">
          <div>
            ...
            <div class="relative">
              ...
              <input id="id_number" name="id_number" type="text" required class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field" placeholder="Ex: FR1234567" value="{{ old('id_number') }}">
            </div>
          </div>
          <div>
            ...
            <div class="relative">
              ...
              <input id="iban" name="iban" type="text" class="pl-10 w-full px-3 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none input-field" placeholder="FR76 1234 5678 9012 3456 7890 123" value="{{ old('iban') }}">
            </div>
          </div>
        </div>
