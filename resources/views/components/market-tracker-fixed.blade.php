...
<div class="market-tracker-widget">
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h3 class="text-xl font-bold text-white">{{ __('market.title_tracker') }}</h3>
                <p class="market-muted text-sm" id="last-update">{{ __('market.last_update_now') }}</p>
            </div>
        </div>
        <button id="refresh-btn" class="p-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors duration-200" title="{{ __('market.refresh') }}">
    ...
    <div id="loading-state" class="hidden flex items-center justify-center py-12">
        ...
        <span class="ml-3 market-muted">{{ __('market.loading') }}</span>
    </div>
    ...
    <div id="error-state" class="hidden flex flex-col items-center justify-center py-12">
        ...
        <p class="text-red-400 mb-4">{{ __('market.error_loading') }}</p>
