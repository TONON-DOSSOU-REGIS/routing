...
<div class="support-hero-slider" aria-hidden="true">
    <div class="support-hero-slide active" style="background-image: url('{{ asset('images/photo-154.avif') }}');"></div>
    <div class="support-hero-slide" style="background-image: url('{{ asset('images/photo-15.avif') }}');"></div>
    <div class="support-hero-slide" style="background-image: url('{{ asset('images/services.jpg') }}');"></div>
    <div class="support-hero-slide" style="background-image: url('{{ asset('images/zabra.avif') }}');"></div>
