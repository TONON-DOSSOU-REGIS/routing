...
<head>
    ...
    <title>Cartes de paiement - BankPro</title>
...
<body class="bg-gray-50">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('register') }}" class="btn-premium w-full py-3 rounded-lg font-semibold text-center block">
                            Choisir cette carte
                        </a>
                    </div>
                </div>
    ...
    <section class="py-24 bg-gradient-to-r from-orange-900 to-orange-800 text-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-xl mb-8 text-orange-100 leading-relaxed">
                Rejoignez les entreprises qui font confiance à BankPro pour leurs solutions de paiement modernes.
            </p>
