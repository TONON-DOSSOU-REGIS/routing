...
<head>
    ...
    <title>Mentions légales - BankPro</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto fade-in-up">
                ...
                <p class="text-xl mb-8 text-gray-100 leading-relaxed">
                    Informations légales et réglementaires concernant BankPro
            ...
            <div class="prose prose-lg max-w-none">
                ...
                <div class="premium-card rounded-2xl p-8 mb-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        ...
                        <p>Directeur Général de BankPro SAS</p>
                    </div>
                </div>
                ...
                <div class="premium-card rounded-2xl p-8 mb-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        <p>BankPro est enregistré auprès de l'Autorité de Contrôle Prudentiel et de Résolution (ACPR) :</p>
                ...
                <div class="premium-card rounded-2xl p-8 mb-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        <p>L'utilisation du site web bankpro.fr et de nos services est soumise aux présentes conditions générales d'utilisation.</p>
                        ...
                        <p>BankPro propose des services bancaires en ligne destinés aux professionnels : comptes courants, virements, cartes de paiement, gestion de trésorerie.</p>
                ...
                <div class="premium-card rounded-2xl p-8 mb-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        <p>Conformément au Règlement Général sur la Protection des Données (RGPD), BankPro s'engage à :</p>
                        <ul class="list-disc list-inside space-y-2 ml-4">
                        ...
                        <p>Les données sont accessibles uniquement au personnel autorisé de BankPro et à nos prestataires techniques.</p>
                    </div>
                </div>
                ...
                <div class="premium-card rounded-2xl p-8 mb-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        <p>Le site bankpro.fr utilise des cookies pour améliorer l'expérience utilisateur :</p>
                        <ul class="list-disc list-inside space-y-2 ml-4">
                ...
                <div class="premium-card rounded-2xl p-8 mb-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        <p>Le site bankpro.fr et son contenu sont protégés par le droit d'auteur et les droits de propriété intellectuelle.</p>
                        <p>La marque "BankPro", le logo et tous les éléments graphiques sont la propriété exclusive de BankPro SAS.</p>
                ...
                <div class="premium-card rounded-2xl p-8 mb-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        <p>BankPro met tout en œuvre pour assurer la disponibilité et la sécurité de ses services.</p>
                        <p>Cependant, la responsabilité de BankPro ne peut être engagée en cas d'interruption due à des circonstances extérieures (maintenance, panne technique, etc.).</p>
                ...
                <div class="premium-card rounded-2xl p-8 mb-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        <p>BankPro se réserve le droit de modifier les présentes mentions légales à tout moment.</p>
                ...
                <div class="premium-card rounded-2xl p-8">
                    ...
                    <div class="space-y-4 text-gray-700">
                        ...
                        <ul class="list-none space-y-2">
                            <li><i class="fas fa-envelope mr-2 text-blue-600"></i> contact@bankpro.fr</li>
