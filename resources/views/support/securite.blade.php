  ...
  @include('components.background-slider')
    ...
    <section class="support-hero relative pt-32 pb-20 text-white" data-support-hero data-hero-tone="red">
        ...
        <div class="support-hero-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto">
                <h1 class="text-4xl sm:text-5xl font-bold mb-6">{{ __('support.security_hero_title') }}</h1>
                <p class="text-xl mb-8 text-red-100 leading-relaxed">{{ __('support.security_hero_subtitle') }}</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-4xl font-bold mb-6 text-premium">{{ __('support.security_overview_title') }}</h2>
                <p class="text-xl text-gray-600 leading-relaxed">{{ __('support.security_overview_desc') }}</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="premium-card rounded-2xl p-8 text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-3 text-premium">{{ __('support.security_card1_title') }}</h3>
                    <p class="text-gray-600">{{ __('support.security_card1_desc') }}</p>
                </div>
                <div class="premium-card rounded-2xl p-8 text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-3 text-premium">{{ __('support.security_card2_title') }}</h3>
                    <p class="text-gray-600">{{ __('support.security_card2_desc') }}</p>
                </div>
                <div class="premium-card rounded-2xl p-8 text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-3 text-premium">{{ __('support.security_card3_title') }}</h3>
                    <p class="text-gray-600">{{ __('support.security_card3_desc') }}</p>
                </div>
                <div class="premium-card rounded-2xl p-8 text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-3 text-premium">{{ __('support.security_card4_title') }}</h3>
                    <p class="text-gray-600">{{ __('support.security_card4_desc') }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-gradient-to-r from-red-900 to-red-800 text-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl font-bold mb-6">{{ __('support.security_cta_title') }}</h2>
            <p class="text-xl mb-8 text-red-100 leading-relaxed">{{ __('support.security_cta_desc') }}</p>
            <a href="{{ localized_route('register', ['locale' => app()->getLocale()]) }}" class="btn-premium px-12 py-5 rounded-lg text-2xl font-bold inline-block">{{ __('support.security_cta_btn') }}</a>
        </div>
    </section>
