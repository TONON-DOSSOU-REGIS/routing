...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-xl text-gray-600 leading-relaxed">
                    BankPro applique les standards de sécurité les plus élevés du secteur bancaire,
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-xl text-gray-600 leading-relaxed">
                    BankPro respecte les normes les plus strictes du secteur bancaire et financier.
                </p>
            </div>
    ...
    <section class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-xl text-gray-600 leading-relaxed">
                    Quelques bonnes pratiques pour protéger votre compte BankPro au quotidien.
                </p>
            </div>
    ...
    <section class="py-24 bg-gradient-to-r from-red-900 to-red-800 text-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-xl mb-8 text-red-100 leading-relaxed">
                Avec BankPro, vos données et vos fonds sont protégés par les technologies
