...
<head>
    ...
    <title><?php echo e(__('support.contact_title')); ?></title>
...
<!-- NAVIGATION -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="mobile-menu" class="hidden md:hidden bg-blue-900 border-t border-blue-700">
                <div class="px-4 py-4 space-y-4 text-center">
                    <a href="<?php echo e(localized_route('login', ['locale' => app()->getLocale()])); ?>" class="block text-white py-2"><?php echo e(__('support.login')); ?></a>
                    <a href="<?php echo e(localized_route('register', ['locale' => app()->getLocale()])); ?>" class="block text-white py-2"><?php echo e(__('support.create_account')); ?></a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section class="hero-image text-white pt-32 pb-24 text-center">
        <h1 class="text-5xl font-bold mb-6"><?php echo e(__('support.contact_hero_title')); ?></h1>
        <p class="text-xl text-blue-100 max-w-3xl mx-auto">
            <?php echo e(__('support.contact_hero_subtitle')); ?>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <h2 class="text-4xl font-bold text-center text-premium mb-14"><?php echo e(__('support.contact_how_to_reach')); ?></h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div class="premium-card p-8 text-center rounded-2xl">
                    ...
                    <h3 class="text-2xl font-semibold mb-3 text-premium"><?php echo e(__('support.contact_phone')); ?></h3>
                    <p class="text-gray-600 mb-2"><?php echo e(__('support.contact_phone_hours')); ?></p>
                    <p class="font-semibold text-premium"><?php echo e(__('support.contact_phone_number')); ?></p>
                </div>
                ...
                <div class="premium-card p-8 text-center rounded-2xl">
                    ...
                    <h3 class="text-2xl font-semibold mb-3 text-premium"><?php echo e(__('support.contact_email')); ?></h3>
                    <p class="text-gray-600 mb-2"><?php echo e(__('support.contact_email_response')); ?></p>
                    <p class="font-semibold text-premium"><?php echo e(__('support.contact_email_address')); ?></p>
                </div>
                ...
                <div class="premium-card p-8 text-center rounded-2xl">
                    ...
                    <h3 class="text-2xl font-semibold mb-3 text-premium"><?php echo e(__('support.contact_chat')); ?></h3>
                    <p class="text-gray-600 mb-2"><?php echo e(__('support.contact_chat_response')); ?></p>
                    <p class="font-semibold text-premium"><?php echo e(__('support.contact_chat_available')); ?></p>
                </div>
                ...
                <div class="premium-card p-8 text-center rounded-2xl">
                    ...
                    <h3 class="text-2xl font-semibold mb-3 text-premium"><?php echo e(__('support.contact_appointment')); ?></h3>
                    <p class="text-gray-600 mb-2"><?php echo e(__('support.contact_appointment_location')); ?></p>
                    <p class="font-semibold text-premium"><?php echo e(__('support.contact_appointment_request')); ?></p>
                </div>
    ...
    <section class="py-24 contact-section-bg text-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <h2 class="text-4xl font-bold text-center mb-14"><?php echo e(__('support.contact_form_title')); ?></h2>

            <div class="grid lg:grid-cols-2 gap-14">

                <!-- FORMULAIRE -->
                <div class="premium-card p-8 text-gray-800 rounded-2xl">
                    <form method="POST" action="<?php echo e(localized_route('support.nous-contacter.store', ['locale' => app()->getLocale()])); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>

                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                <label class="font-semibold"><?php echo e(__('support.contact_form_first_name')); ?></label>
                                <input type="text" name="first_name" class="w-full mt-2 border rounded-lg p-3" required>
                            </div>
                            <div>
                                <label class="font-semibold"><?php echo e(__('support.contact_form_last_name')); ?></label>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                <label class="font-semibold"><?php echo e(__('support.contact_form_email')); ?></label>
                                <input type="email" name="email" class="w-full mt-2 border rounded-lg p-3" required>
                            </div>
                            <div>
                                <label class="font-semibold"><?php echo e(__('support.contact_form_phone')); ?></label>
                                <input type="tel" name="phone" class="w-full mt-2 border rounded-lg p-3">
                            </div>
                        </div>

                        <div>
                            <label class="font-semibold"><?php echo e(__('support.contact_form_subject')); ?></label>
                            <select name="subject" class="w-full mt-2 border rounded-lg p-3" required>
                                <option value=""><?php echo e(__('support.contact_form_select_subject')); ?></option>
                                <option value="support"><?php echo e(__('support.contact_form_subject_support')); ?></option>
                                <option value="commercial"><?php echo e(__('support.contact_form_subject_commercial')); ?></option>
                                <option value="partnership"><?php echo e(__('support.contact_form_subject_partnership')); ?></option>
                                <option value="press"><?php echo e(__('support.contact_form_subject_press')); ?></option>
                                <option value="other"><?php echo e(__('support.contact_form_subject_other')); ?></option>
                            </select>
                        </div>

                        <div>
                            <label class="font-semibold"><?php echo e(__('support.contact_form_message')); ?></label>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <label class="text-sm text-gray-700"><?php echo __('support.contact_form_privacy'); ?></label>
                        </div>

                        <button class="btn-premium px-10 py-4 rounded-lg text-lg mt-4 w-full">
                            <?php echo e(__('support.contact_form_send')); ?>
                ...
                <div class="premium-card p-8 rounded-2xl">
                    <h3 class="text-2xl font-bold text-premium text-center mb-6"><?php echo e(__('support.contact_offices_title')); ?></h3>
                    ...
                    <div class="mt-6 text-gray-800 space-y-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-medium"><?php echo e(__('support.contact_office_address')); ?></p>
                                <p class="text-gray-600"><?php echo e(__('support.contact_office_city')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-medium"><?php echo e(__('support.contact_office_hours')); ?></p>
                                <p class="text-gray-600"><?php echo e(__('support.contact_office_weekend')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-medium"><?php echo e(__('support.contact_office_phone')); ?></p>
                                <p class="text-gray-600"><?php echo e(__('support.contact_office_phone_label')); ?></p>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="bg-gray-900 text-gray-400 text-center py-10">
        &copy; 2025 <span class="text-blue-400 font-semibold">Valtrix Bank</span>. <?php echo e(__('support.all_rights_reserved')); ?>
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\support\nous-contacter.blade.php ENDPATH**/ ?>