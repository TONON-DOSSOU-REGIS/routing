...
<div class="min-h-screen bg-slate-900/60 relative z-[1]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-white"><?php echo e(__('notifications.title')); ?></h1>
                    <p class="mt-2 text-red-100"><?php echo e(__('notifications.subtitle')); ?></p>
                </div>
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    <button id="mark-all-read-btn" class="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors w-full sm:w-auto">
                        <i class="fas fa-check-double mr-2"></i><?php echo e(__('notifications.mark_all_read')); ?>
                    ...
                    <button id="delete-read-btn" class="inline-flex items-center justify-center bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-medium transition-colors w-full sm:w-auto">
                        <i class="fas fa-trash mr-2"></i><?php echo e(__('notifications.delete_read')); ?>
    ...
    <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('notifications.filter_type')); ?></label>
                    <select id="type-filter" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value=""><?php echo e(__('notifications.all_types')); ?></option>
                        <option value="transaction"><?php echo e(__('notifications.type_transaction')); ?></option>
                        <option value="account"><?php echo e(__('notifications.type_account')); ?></option>
                        <option value="alert"><?php echo e(__('notifications.type_alert')); ?></option>
                        <option value="system"><?php echo e(__('notifications.type_system')); ?></option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('notifications.filter_status')); ?></label>
                    <select id="status-filter" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value=""><?php echo e(__('notifications.status_all')); ?></option>
                        <option value="unread"><?php echo e(__('notifications.status_unread')); ?></option>
                        <option value="read"><?php echo e(__('notifications.status_read')); ?></option>
                    </select>
                </div>
                <div class="flex items-end sm:col-span-2 lg:col-span-1">
                    <button id="apply-filters" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-medium transition-colors w-full">
                        <i class="fas fa-filter mr-2"></i><?php echo e(__('notifications.filter_apply')); ?>
            ...
            <div id="notifications-container">
                ...
                <div class="p-8 text-center">
                    <div class="inline-flex items-center">
                        ...
                        <span class="text-gray-600"><?php echo e(__('notifications.loading')); ?></span>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const i18n = <?php echo json_encode($notificationIndexI18n, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerveau\resources\views\notifications\index.blade.php ENDPATH**/ ?>