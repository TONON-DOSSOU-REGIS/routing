...
<?php $__env->startSection('dashboard_section_label', 'Control room'); ?>
<?php $__env->startSection('dashboard_search_placeholder', 'Rechercher un client, une transaction, une operation ou un statut...'); ?>
<?php $__env->startSection('dashboard_brand_title', 'Valtrix Admin'); ?>
<?php $__env->startSection('dashboard_brand_subtitle', 'Control center'); ?>
...
<?php $__env->startSection('sidebar_secondary_title', 'Operations'); ?>
    ...
    <div class="premium-gradient-card premium-grid-glow relative overflow-hidden rounded-[26px] p-5">
        <div class="relative z-10">
            ...
            <p class="mt-2 text-sm leading-6 text-white/78">
                <?php echo e($activeUsersRate); ?>% du parc client est actif. Les files prioritaires et le chat admin restent accessibles depuis ce centre de pilotage.
            </p>
                ...
                <div class="flex min-w-0 flex-col gap-6 lg:items-start 2xl:flex-row 2xl:justify-between">
                    <div class="min-w-0 max-w-2xl">
                        ...
                        <h2 class="mt-4 premium-page-title text-3xl font-semibold tracking-[-0.05em] sm:text-4xl">
                            <?php echo e($totalUsers); ?> clients supervises
                        </h2>
        ...
        <section class="premium-panel premium-card-hover min-w-0 rounded-[30px] p-5">
            <div class="flex items-start justify-between gap-3">
                ...
                <span class="rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700">
                    <?php echo e($pendingUsersCount + $pendingTransactionsCount); ?> elements
                </span>
            </div>
