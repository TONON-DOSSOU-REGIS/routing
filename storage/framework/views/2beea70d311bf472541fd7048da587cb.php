...
<?php $__env->startSection('title', 'Paramètres admin - Valtrix Bank'); ?>
<?php $__env->startSection('admin_nav_active', 'settings'); ?>
<?php $__env->startSection('dashboard_page_title', 'Paramètres des virements'); ?>
...
<?php $__env->startSection('dashboard_section_label', 'Paramètres système'); ?>
...
<?php $__env->startSection('dashboard_content'); ?>
    <section class="premium-gradient-card premium-grid-glow relative overflow-hidden rounded-[30px] p-6 sm:p-7">
        <div class="relative z-10 grid gap-3 sm:grid-cols-2 2xl:grid-cols-4">
            ...
            <div class="rounded-[24px] bg-white/10 px-4 py-4 backdrop-blur-sm"><p class="text-xs uppercase tracking-[0.18em] text-white/60">Portée</p><p class="premium-kpi-number mt-2 text-2xl font-semibold"><?php echo e($isGlobal ? 'Globale' : 'Spécifique'); ?></p></div>
            ...
            <div class="rounded-[24px] bg-white/10 px-4 py-4 backdrop-blur-sm"><p class="text-xs uppercase tracking-[0.18em] text-white/60">Files à traiter</p><p class="premium-kpi-number mt-2 text-2xl font-semibold"><?php echo e($pendingTransactionsCount); ?></p></div>
        </div>
    </section>
        ...
        <aside class="space-y-6">
            <section class="admin-surface rounded-[30px] p-5">
                ...
                <div class="mt-5 rounded-[24px] bg-amber-50 px-4 py-4 ring-1 ring-amber-200/80">
                    ...
                    <p class="mt-3 text-sm text-amber-800">Le virement s'arrêtera à <span id="preview-percentage" class="font-semibold"><?php echo e($stopPercentage); ?>%</span>.</p>
                </div>
            </section>
