    ...
    <div class="receipt-container">
        ...
        <div class="content">
            ...
            <div class="message-prompt">
                <?php if($transaction->progress == 100): ?>
                    <img src="/images/validate-icon.png" alt="Validated"/>
                    Le virement a été effectué à 100% avec succès.
                <?php elseif($transaction->progress < 100): ?>
                    <img src="/images/alert-icon.png" alt="Alert"/>
                    Le virement est en cours, à <?php echo e($transaction->progress); ?>% de progression.
                <?php endif; ?>
            </div>
            ...
            <div class="status">
                <span class="status-badge
                    <?php if($transaction->status == 'success'): ?> status-success
                    <?php elseif($transaction->status == 'pending'): ?> status-pending
                    <?php else: ?> status-on_hold <?php endif; ?>">
            ...
            <div class="transaction-info">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo e($transaction->created_at->format('d/m/Y H:i:s')); ?></span>
                </div>
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo e($transaction->recipient_bic); ?></span>
                </div>
                <?php endif; ?>
                ...
                <?php if($transaction->activation_code): ?>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo e($transaction->progress); ?>%</span>
                </div>
            </div>
            ...
            <div class="bank-details">
                ...
                <div class="info-row" style="border: none; margin-bottom: 5px;">
                    ...
                    <span class="value"><?php echo e($transaction->user->first_name); ?> <?php echo e($transaction->user->last_name); ?></span>
                </div>
                <div class="info-row" style="border: none; margin-bottom: 5px;">
                    <span class="label">Email:</span>
                    <span class="value"><?php echo e($transaction->user->email); ?></span>
                </div>
                <?php if($transaction->user->phone): ?>
                <div class="info-row" style="border: none; margin-bottom: 0;">
                    <span class="label">Téléphone:</span>
                    <span class="value"><?php echo e($transaction->user->phone); ?></span>
                </div>
                <?php endif; ?>
            </div>
            ...
            <?php if($transaction->status == 'on_hold' && $transaction->message): ?>
        ...
        <div class="footer">
            ...
            <p>Ce document a été généré automatiquement le <?php echo e(now()->format('d/m/Y à H:i:s')); ?></p>
            <p>Pour toute question, contactez notre service client</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views/transactions/receipt.blade.php ENDPATH**/ ?>
