...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="user-info">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo e($loginTime->format('d/m/Y H:i:s')); ?></span>
                </div>
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo e($userAgent); ?></span>
                </div>
            </div>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="<?php echo e(localized_route('admin.users')); ?>" class="action-button">
                    👥 Voir tous les utilisateurs
                </a>
                <a href="<?php echo e(localized_route('admin.dashboard')); ?>" class="action-button">
        ...
        <div class="footer">
            ...
            <p>Cette notification a été générée automatiquement le <?php echo e(now()->format('d/m/Y à H:i:s')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\emails\user_login_notification.blade.php ENDPATH**/ ?>