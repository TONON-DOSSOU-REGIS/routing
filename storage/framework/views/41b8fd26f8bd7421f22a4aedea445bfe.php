...
<?php $__env->startSection('dashboard_page_subtitle', 'Supervisez les virements, depots, retraits et remboursements depuis une interface premium alignee sur le control room admin.'); ?>
<?php $__env->startSection('dashboard_section_label', 'Transaction desk'); ?>

<?php $__env->startSection('dashboard_header_actions'); ?>
    <a href="<?php echo e(localized_route('admin.export.pdf')); ?>" class="inline-flex items-center gap-2 rounded-full bg-blue-700 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-900/20 transition hover:bg-blue-800">
    ...
    <section class="premium-gradient-card premium-grid-glow relative overflow-hidden rounded-[30px] p-6 sm:p-7">
        <div class="relative z-10 grid gap-3 sm:grid-cols-2 2xl:grid-cols-4">
            ...
            <div class="rounded-[24px] bg-white/10 px-4 py-4 backdrop-blur-sm">
                ...
                <p class="mt-2 text-xs text-white/72"><?php echo e($filteredRefundedCount); ?> deja remboursees.</p>
            </div>
            <div class="rounded-[24px] bg-white/10 px-4 py-4 backdrop-blur-sm">
                ...
                <p class="mt-2 text-xs text-white/72"><?php echo e($filteredSuccessCount); ?> operation(s) reussie(s).</p>
            </div>
        </div>
    </section>
            ...
            <section class="admin-surface rounded-[30px] p-5 sm:p-6">
                <div class="flex flex-col gap-4 border-b border-slate-200/70 pb-5 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm leading-6 text-slate-500">
                            <?php echo e($activeFiltersCount); ?> filtre(s) actif(s). Ajustez la recherche pour cibler un utilisateur, un statut ou une periode.
                        </p>
                    </div>
                ...
                <form method="GET" action="<?php echo e(localized_route('admin.transactions')); ?>" class="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    <div class="xl:col-span-2">
                        ...
                        <input type="text" name="search" id="search" value="<?php echo e(request('search')); ?>" placeholder="ID, client, email ou beneficiaire..." class="admin-field w-full rounded-2xl px-4 py-3 text-sm text-slate-700">
                    </div>
                    <div>
                        ...
                        <select name="type" id="type" class="admin-field w-full rounded-2xl px-4 py-3 text-sm text-slate-700">
                            ...
                            <option value="deposit" <?php echo e(request('type') === 'deposit' ? 'selected' : ''); ?>>Depot</option>
                    ...
                    <div>
                        ...
                        <select name="status" id="status" class="admin-field w-full rounded-2xl px-4 py-3 text-sm text-slate-700">
                            ...
                            <option value="success" <?php echo e(request('status') === 'success' ? 'selected' : ''); ?>>Reussi</option>
            ...
            <section class="admin-surface rounded-[30px] p-5 sm:p-6">
                <div class="flex flex-col gap-4 border-b border-slate-200/70 pb-5 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-4 py-2 text-xs font-semibold text-emerald-700 ring-1 ring-emerald-200/80">
                            ...
                            <?php echo e($filteredSuccessCount); ?> succes
                        </span>
                        <span class="inline-flex items-center gap-2 rounded-full bg-amber-50 px-4 py-2 text-xs font-semibold text-amber-700 ring-1 ring-amber-200/80">
                            ...
                            <?php echo e($filteredReviewCount); ?> a revoir
                        </span>
                    </div>
                </div>
                                    ...
                                    <tr class="admin-row">
                                        <td class="px-4 py-4">
                                            <div class="min-w-0">
                                                ...
                                                <p class="mt-2 text-sm text-slate-500"><?php echo e($transaction->reason ?: 'Aucun motif renseigne'); ?></p>
                                            </div>
                                        </td>
                                        <td class="px-4 py-4">
                                        ...
                                        <td class="px-4 py-4">
                                            <?php if($transaction->recipient_name): ?>
                                                ...
                                                <p class="mt-1 text-sm text-slate-500"><?php echo e($transaction->bank_name ?: 'Banque non renseignee'); ?></p>
                                            <?php else: ?>
                ...
                <?php if($transactions->hasPages()): ?>
                    <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div><?php echo e($transactions->links('vendor.pagination.tailwind')); ?></div>
                    </div>
                <?php endif; ?>
            </section>
        </section>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="rounded-[22px] bg-slate-50 px-4 py-4 ring-1 ring-slate-200/70">
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <span class="text-sm font-semibold text-slate-900"><?php echo e(\App\Helpers\CurrencyHelper::format($transaction->amount, $transaction->user->default_currency ?? 'EUR')); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
