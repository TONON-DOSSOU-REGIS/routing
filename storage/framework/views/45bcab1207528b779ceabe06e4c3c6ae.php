...
<head>
    ...
    <title><?php echo e(__("services.treasury_page_title")); ?></title>
...
<!-- Navigation -->
        ...
        <div class="support-hero-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto fade-in-up">
                <h1 class="text-4xl sm:text-5xl font-bold mb-6">
                    <?php echo e(__("services.treasury_hero_title")); ?>

                </h1>
                <p class="text-xl mb-8 text-purple-100 leading-relaxed">
                    <?php echo e(__("services.treasury_hero_desc")); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(localized_route('register', ['locale' => app()->getLocale()])); ?>" class="btn-premium px-8 py-4 rounded-lg font-semibold text-center">
                        <?php echo e(__("services.treasury_hero_cta_primary")); ?>
                    ...
                    <a href="#features" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-purple-900 transition text-center">
                        <?php echo e(__("services.treasury_hero_cta_secondary")); ?>
    ...
    <section id="features" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-4xl font-bold mb-6 text-premium"><?php echo e(__("services.treasury_features_title")); ?></h2>
                <p class="text-xl text-gray-600 leading-relaxed">
                    <?php echo e(__("services.treasury_features_desc")); ?>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.treasury_f1_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.treasury_f1_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.treasury_f2_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.treasury_f2_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.treasury_f3_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.treasury_f3_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.treasury_f4_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.treasury_f4_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.treasury_f5_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.treasury_f5_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.treasury_f6_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.treasury_f6_desc")); ?>
    ...
    <section class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-4xl font-bold mb-6 text-premium"><?php echo e(__("services.treasury_dashboard_title")); ?></h2>
                <p class="text-xl text-gray-600 leading-relaxed">
                    <?php echo e(__("services.treasury_dashboard_desc")); ?>
            ...
            <div class="premium-card rounded-3xl p-8 max-w-6xl mx-auto">
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl p-6 text-center">
                        ...
                        <div class="text-sm opacity-90"><?php echo e(__("services.treasury_kpi_balance")); ?></div>
                    </div>
                    <div class="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl p-6 text-center">
                        ...
                        <div class="text-sm opacity-90"><?php echo e(__("services.treasury_kpi_in")); ?></div>
                    </div>
                    <div class="bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-xl p-6 text-center">
                        ...
                        <div class="text-sm opacity-90"><?php echo e(__("services.treasury_kpi_out")); ?></div>
                    </div>
                    <div class="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-xl p-6 text-center">
                        ...
                        <div class="text-sm opacity-90"><?php echo e(__("services.treasury_kpi_growth")); ?></div>
                    </div>
                </div>

                <div class="bg-gray-50 rounded-xl p-6">
                    <h3 class="font-bold text-lg mb-4 text-premium"><?php echo e(__("services.treasury_chart_title")); ?></h3>
                    <div class="h-64 bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg flex items-center justify-center">
                        <div class="text-center text-gray-500">
                            ...
                            <p><?php echo e(__("services.treasury_chart_placeholder_title")); ?></p>
                            <p class="text-sm"><?php echo e(__("services.treasury_chart_placeholder_subtitle")); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-24 bg-gradient-to-r from-purple-900 to-purple-800 text-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl font-bold mb-6"><?php echo e(__("services.treasury_cta_title")); ?></h2>
            <p class="text-xl mb-8 text-purple-100 leading-relaxed">
                <?php echo e(__("services.treasury_cta_desc")); ?>
            ...
            <a href="<?php echo e(localized_route('register', ['locale' => app()->getLocale()])); ?>" class="btn-premium px-12 py-5 rounded-lg text-2xl font-bold inline-block">
                <?php echo e(__("services.treasury_cta_btn")); ?>
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\services\gestion-tresorerie.blade.php ENDPATH**/ ?>