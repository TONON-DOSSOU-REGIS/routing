...
<div x-data="marketTracker()" x-cloak>
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center">
            ...
            <div>
                <h3 class="text-xl font-bold text-gray-900"><?php echo e(__('market.title_realtime')); ?></h3>
                <p class="text-gray-600 mt-1"><?php echo e(__('market.subtitle_realtime')); ?></p>
            </div>
        </div>
    ...
    <div x-show="loading && !marketData.length" x-transition.opacity class="text-center py-12">
        ...
        <p class="text-gray-600 mt-4"><?php echo e(__('market.loading')); ?></p>
    ...
    <div x-show="error" x-transition.opacity class="text-center py-12">
        ...
        <p class="text-red-600 font-medium"><?php echo e(__('market.error_loading')); ?></p>
        <button @click="refreshData()" class="mt-4 text-blue-600 hover:text-blue-700 font-medium">
            <i class="fas fa-redo mr-2"></i><?php echo e(__('market.retry')); ?>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-xs text-gray-500" x-show="item.volume_24h || item.volume">
                            <?php echo e(__('market.volume_label')); ?> <span x-text="formatVolume(item)"></span>
                        </div>
                    </div>
...
<script>
const marketLocale = document.documentElement.lang || '<?php echo e(app()->getLocale()); ?>';
const marketI18n = {
    lastUpdateLoading: <?php echo json_encode(__('market.last_update_loading'), 15, 512) ?>,
    lastUpdateNow: <?php echo json_encode(__('market.last_update_now'), 15, 512) ?>,
    typeCrypto: <?php echo json_encode(__('market.type_crypto'), 15, 512) ?>,
    typeStock: <?php echo json_encode(__('market.type_stock'), 15, 512) ?>,
    typeForex: <?php echo json_encode(__('market.type_forex'), 15, 512) ?>,
};
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\components\market-tracker.blade.php ENDPATH**/ ?>