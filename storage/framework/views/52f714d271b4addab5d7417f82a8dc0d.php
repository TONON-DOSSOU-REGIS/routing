        ...
        <div class="min-h-screen relative z-10">
            ...
            <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="mb-8 fade-in-up">
                    <h1 class="text-3xl font-bold text-white drop-shadow-lg text-center"><?php echo e(__('transactions.transfer_title')); ?></h1>
                ...
                <div class="glass-card rounded-2xl p-6 mb-8 fade-in-up">
                    <div class="flex items-center justify-between max-w-md mx-auto">
                        <div class="flex flex-col items-center">
                            ...
                            <span class="text-sm font-medium text-gray-700 mt-2"><?php echo e(__('transactions.step_information')); ?></span>
                        </div>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <span class="text-sm font-medium text-gray-500 mt-2"><?php echo e(__('transactions.step_processing')); ?></span>
                        </div>
                        <div class="flex-1 h-1 bg-gray-200 mx-4"></div>
                        <div class="flex flex-col items-center">
                            <div class="step-indicator step-inactive">
                            ...
                            <span class="text-sm font-medium text-gray-500 mt-2"><?php echo e(__('transactions.step_confirmation')); ?></span>
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div id="flashOverlay" class="fixed inset-0 hidden grid place-items-center bg-black bg-opacity-70 z-[9999] p-4">
        <div id="flashCard" class="glass-card max-w-md w-full mx-auto p-8 rounded-2xl shadow-2xl text-center animate-pulse border border-red-200">
            ...
            <h3 id="flashTitle" class="text-xl font-bold text-gray-900 mb-3"><?php echo e(__('transactions.operation_interrupted')); ?></h3>
