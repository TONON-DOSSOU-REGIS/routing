...
<?php $__env->startSection('dashboard_page_title', __('transactions.transfer_title')); ?>
<?php $__env->startSection('dashboard_page_subtitle', __('transactions.transfer_subtitle')); ?>
...
<?php $__env->startSection('sidebar_primary'); ?>
    ...
    <a href="<?php echo e(localized_route('transfer.create')); ?>" class="premium-nav-item is-active flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-slate-900">
...
<?php $__env->startSection('dashboard_header_actions'); ?>
    ...
    <a href="<?php echo e(localized_route('transactions.history')); ?>" class="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-slate-300 hover:bg-slate-50">
        ...
        <?php echo e(__('dashboard.history')); ?>
...
<?php $__env->startSection('dashboard_content'); ?>
    <section class="premium-gradient-card premium-grid-glow relative overflow-hidden rounded-[30px] p-6 sm:p-7">
        <div class="relative z-10 flex flex-col gap-6 2xl:flex-row 2xl:items-end 2xl:justify-between">
            <div class="max-w-3xl">
                <p class="text-sm uppercase tracking-[0.22em] text-white/65"><?php echo e(__('dashboard.secure_session')); ?></p>
                <h2 class="mt-4 premium-page-title text-3xl font-semibold tracking-[-0.05em] sm:text-4xl">
                    <?php echo e(__('transactions.transfer_details')); ?>

                </h2>
                <p class="mt-3 text-sm leading-6 text-white/78 sm:text-base">
                    <?php echo e(__('transactions.transfer_subtitle')); ?>
            ...
            <div class="grid gap-3 sm:grid-cols-3 2xl:min-w-[520px]">
                <div class="rounded-[24px] bg-white/10 px-4 py-4 backdrop-blur-sm">
                    <p class="text-xs uppercase tracking-[0.18em] text-white/60"><?php echo e(__('dashboard.current_balance')); ?></p>
                    <p class="premium-kpi-number mt-2 text-2xl font-semibold"><?php echo e($balanceFormatted); ?></p>
                </div>
                <div class="rounded-[24px] bg-white/10 px-4 py-4 backdrop-blur-sm">
                    <p class="text-xs uppercase tracking-[0.18em] text-white/60"><?php echo e(__('dashboard.operations_to_track')); ?></p>
                    <p class="premium-kpi-number mt-2 text-2xl font-semibold"><?php echo e($pendingOperationsCount); ?></p>
                </div>
                <div class="rounded-[24px] bg-white/10 px-4 py-4 backdrop-blur-sm">
                    <p class="text-xs uppercase tracking-[0.18em] text-white/60"><?php echo e(__('dashboard.notifications')); ?></p>
                    <p class="premium-kpi-number mt-2 text-2xl font-semibold"><?php echo e($unreadNotificationsCount); ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <section class="space-y-6">
            <div class="premium-panel rounded-[30px] bg-slate-900 p-5 sm:p-6">
                <div class="grid gap-3 sm:grid-cols-3">
                    <div class="transfer-step is-active rounded-[24px] px-4 py-4 text-white">
                        ...
                        <p class="mt-4 text-sm font-semibold"><?php echo e(__('transactions.step_information')); ?></p>
                    </div>
                    <div class="transfer-step rounded-[24px] px-4 py-4 text-white/82">
                        ...
                        <p class="mt-4 text-sm font-semibold"><?php echo e(__('transactions.step_processing')); ?></p>
                    </div>
                    <div class="transfer-step rounded-[24px] px-4 py-4 text-white/82">
                        <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/12 text-sm shadow-sm">
                            <i class="fas fa-check"></i>
                        </div>
                        <p class="mt-4 text-sm font-semibold"><?php echo e(__('transactions.step_confirmation')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <section class="premium-panel premium-card-hover rounded-[30px] p-5 sm:p-6">
                <div class="flex flex-col gap-3 border-b border-slate-200/70 pb-5 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400"><?php echo e(__('dashboard.immediate_summary')); ?></p>
                        <h2 class="mt-2 premium-brand-title text-2xl font-semibold text-slate-950"><?php echo e(__('transactions.transfer_details')); ?></h2>
                        <p class="mt-2 text-sm leading-6 text-slate-500"><?php echo e(__('transactions.beneficiary_info')); ?></p>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="transfer-group rounded-[28px] p-5">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-slate-950"><?php echo e(__('transactions.beneficiary_info')); ?></h3>
                                    <p class="mt-1 text-sm text-slate-500"><?php echo e(__('transactions.recipient_name')); ?></p>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="transfer-group rounded-[28px] p-5">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-slate-950"><?php echo e(__('transactions.banking_details')); ?></h3>
                                    <p class="mt-1 text-sm text-slate-500"><?php echo e(__('transactions.recipient_iban')); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="mt-5 space-y-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="recipient_iban"
                                        name="recipient_iban"
                                        value="<?php echo e(old('recipient_iban')); ?>"
                                        required
                                        class="transfer-field input-field block w-full rounded-2xl px-4 py-3.5 text-sm text-slate-900 placeholder:text-slate-400"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="recipient_bic"
                                        name="recipient_bic"
                                        value="<?php echo e(old('recipient_bic')); ?>"
                                        required
                                        class="transfer-field input-field block w-full rounded-2xl px-4 py-3.5 text-sm text-slate-900 placeholder:text-slate-400"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="transfer-group rounded-[28px] p-5 xl:col-span-2">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-slate-950"><?php echo e(__('transactions.additional_info')); ?></h3>
                                    <p class="mt-1 text-sm text-slate-500"><?php echo e(__('transactions.activation_code')); ?></p>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col-reverse gap-3 border-t border-slate-200/70 pt-6 sm:flex-row sm:items-center sm:justify-between">
                        <a href="<?php echo e(localized_route('dashboard')); ?>" class="inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-slate-300 hover:bg-slate-50">
            ...
            <section class="premium-panel premium-card-hover rounded-[30px] p-5">
                <div class="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <h2 class="mt-2 premium-brand-title text-2xl font-semibold text-slate-950"><?php echo e(__('transactions.transfer_progress')); ?></h2>
                    </div>
                ...
                <div class="mt-5 space-y-3">
                    ...
                    <div class="transfer-draft-item rounded-[24px] px-4 py-4">
                        ...
                        <p id="transferSummaryRecipient" class="mt-2 text-sm font-semibold text-slate-900"><?php echo e(__('transactions.not_available')); ?></p>
                    </div>
                    <div class="transfer-draft-item rounded-[24px] px-4 py-4">
                        <p class="text-xs uppercase tracking-[0.16em] text-slate-400"><?php echo e(__('transactions.recipient_iban')); ?></p>
                        <p id="transferSummaryIban" class="mt-2 break-all text-sm font-semibold text-slate-900"><?php echo e(__('transactions.not_available')); ?></p>
                    </div>
                </div>
            </section>

            <section class="premium-gradient-card rounded-[30px] p-5">
                <p class="text-xs uppercase tracking-[0.18em] text-white/65"><?php echo e(__('dashboard.current_balance')); ?></p>
                <h3 class="mt-3 premium-brand-title text-3xl font-semibold"><?php echo e($balanceFormatted); ?></h3>
                <div class="mt-5 space-y-3">
                    <div class="rounded-[22px] bg-white/10 px-4 py-3">
                        <p class="text-xs uppercase tracking-[0.16em] text-white/60"><?php echo e(__('transactions.client_name_label')); ?></p>
                        <p class="mt-1 text-sm font-semibold"><?php echo e($user->name); ?></p>
                    </div>
                    <div class="rounded-[22px] bg-white/10 px-4 py-3">
                        <p class="text-xs uppercase tracking-[0.16em] text-white/60"><?php echo e(__('transactions.client_iban_label')); ?></p>
                        <p class="mt-1 break-all text-sm font-semibold"><?php echo e($formattedClientIban); ?></p>
                    </div>
                </div>
            </section>

            <section class="premium-panel premium-card-hover rounded-[30px] p-5">
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400"><?php echo e(__('dashboard.secure_area')); ?></p>
                <h3 class="mt-2 premium-brand-title text-2xl font-semibold text-slate-950"><?php echo e(__('dashboard.priority_access')); ?></h3>
                <p class="mt-3 text-sm leading-6 text-slate-500"><?php echo e(__('dashboard.secure_area_description')); ?></p>
                ...
                <div class="mt-5 space-y-3">
                    <div class="rounded-[24px] bg-slate-50 px-4 py-4 ring-1 ring-slate-200/70">
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <span class="premium-brand-title text-3xl font-semibold text-slate-950"><?php echo e($pendingOperationsCount); ?></span>
                        </div>
                    </div>
        ...
        <div id="flashCard" class="flash-card flash-card--error" role="dialog" aria-modal="true" aria-labelledby="flashTitle" aria-describedby="flashMessage">
            ...
            <div id="flashClientPanel" class="flash-client-panel hidden">
                <span class="flash-client-badge">
                    <i class="fas fa-shield-alt"></i><?php echo e(__('transactions.client_info_title')); ?>

                </span>
                <div class="flash-client-grid">
                    <div class="flash-client-row">
                        <span class="flash-client-label"><?php echo e(__('transactions.client_name_label')); ?></span>
                        <span id="flashClientName" class="flash-client-value"><?php echo e(__('transactions.not_available')); ?></span>
                    </div>
                    <div class="flash-client-row">
                        <span class="flash-client-label"><?php echo e(__('transactions.client_iban_label')); ?></span>
                        <span id="flashClientIban" class="flash-client-value"><?php echo e(__('transactions.not_available')); ?></span>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function formatIban(iban) {
                ...
                if (!compact) {
                    return '<?php echo e(__('transactions.not_available')); ?>';
                }
            ...
            function formatAmount(amount) {
                ...
                if (Number.isNaN(normalized)) {
                    return '0.00 <?php echo e($currencyCode); ?>';
                }
            ...
            function buildClientSnapshot() {
                ...
                return {
                    name: name || '<?php echo e(__('transactions.not_available')); ?>',
            ...
            function updateClientPanel() {
                ...
                flashClientName.textContent = source.name || '<?php echo e(__('transactions.not_available')); ?>';
            ...
            function resetStartButton() {
                ...
                startBtn.innerHTML = '<i class="fas fa-paper-plane text-xs"></i><?php echo e(__('transactions.start_transfer')); ?>';
            }
            ...
            async function handleTransferStart() {
                ...
                try {
                    ...
                    const firstError = data.errors
                        ...
                        : (data.message || '<?php echo e(__('transactions.error_starting_transfer')); ?>');
...
<?php echo $__env->make('layouts.premium-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerveau\resources\views/transactions/create.blade.php ENDPATH**/ ?>