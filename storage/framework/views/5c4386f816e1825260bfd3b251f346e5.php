...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="greeting">Bonjour <?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>,</p>
            ...
            <div class="amount-box">
                ...
                <div class="amount-value"><?php echo e($amount); ?></div>
            </div>
            ...
            <div class="transaction-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">#<?php echo e($transaction->id); ?></span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($transaction->created_at->format('d/m/Y à H:i')); ?></span>
                </div>
                <?php if($transaction->reason): ?>
                <div class="detail-row">
                    <span class="detail-label">Motif</span>
                    <span class="detail-value"><?php echo e($transaction->reason); ?></span>
                </div>
                <?php endif; ?>
            </div>
            ...
            <center>
                <a href="<?php echo e(url('/dashboard')); ?>" class="cta-button">
                    Voir mon compte
                </a>
            </center>
        ...
        <div class="footer">
            ...
            <p>© <?php echo e(date('Y')); ?> Cerveau Banking. Tous droits réservés.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\emails\deposit_notification.blade.php ENDPATH**/ ?>