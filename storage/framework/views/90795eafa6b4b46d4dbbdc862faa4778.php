            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20">
                    <div class="flex items-center">
                        <div class="flex items-center space-x-4">
                            <div class="gradient-vip-gold p-3 rounded-2xl pulse-vip border-gold">
                                <a href="<?php echo e(localized_route('home', ['locale' => app()->getLocale()])); ?>" class="inline-flex items-center justify-center bg-white/95 p-2 rounded-xl shadow-md ring-1 ring-white/60"><img src='<?php echo e(asset("images/Logosite.png")); ?>' class="w-11 h-11 object-contain" alt="logo Valtrix Bank" style="image-rendering: -webkit-optimize-contrast; image-rendering: crisp-edges;"></a>
                            </div>
                            <div>
                                <a href="<?php echo e(localized_route('admin.dashboard')); ?>" class="text-2xl font-bold font-cinzel text-gradient-gold hover:scale-105 transition-transform duration-300" aria-label="Valtrix Bank"><span class="sr-only">Valtrix Bank</span></a>
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        <a href="<?php echo e(localized_route('admin.dashboard')); ?>" class="relative text-gray-700 hover:text-gray-900 transition-all duration-300 font-medium group font-inter text-lg">
                            <i class="fas fa-tachometer-alt mr-2 text-blue-600"></i> Dashboard
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                        </a>
                        <a href="<?php echo e(localized_route('admin.users')); ?>" class="relative text-gray-700 hover:text-gray-900 transition-all duration-300 font-medium group font-inter text-lg">
                        ...
                        <a href="<?php echo e(localized_route('admin.transactions')); ?>" class="relative text-gray-700 hover:text-gray-900 transition-all duration-300 font-medium group font-inter text-lg">
                        ...
                        <a href="<?php echo e(localized_route('admin.deposit')); ?>" class="relative text-gray-700 hover:text-gray-900 transition-all duration-300 font-medium group font-inter text-lg">
                        ...
                        <a href="<?php echo e(localized_route('budgets.index')); ?>" class="relative text-gray-700 hover:text-gray-900 transition-all duration-300 font-medium group font-inter text-lg">
                        ...
                        <a href="<?php echo e(localized_route('admin.settings')); ?>" class="relative text-gray-700 hover:text-gray-900 transition-all duration-300 font-medium group font-inter text-lg">
                        ...
                        <a href="<?php echo e(localized_route('dashboard', ['locale' => app()->getLocale()])); ?>" class="relative text-gray-700 hover:text-gray-900 transition-all duration-300 font-medium group font-inter text-lg">
                        ...
                        <form method="POST" action="<?php echo e(localized_route('logout', ['locale' => app()->getLocale()])); ?>" class="relative">
                            <?php echo csrf_field(); ?>
                ...
                <div class="md:hidden hidden" id="mobile-menu">
                    <div class="px-4 pt-4 pb-4 space-y-2 sm:px-4 glass-card border-gold rounded-2xl shadow-2xl mt-4">
                        <a href="<?php echo e(localized_route('admin.dashboard')); ?>" class="flex items-center px-4 py-4 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-xl transition-all duration-300 border border-gray-200">
                            <i class="fas fa-tachometer-alt w-6 mr-4 text-center text-blue-600"></i> Dashboard
                        </a>
                        <a href="<?php echo e(localized_route('admin.users')); ?>" class="flex items-center px-4 py-4 text-base font-medium text-gray-700 hover:text-green-600 hover:bg-gray-50 rounded-xl transition-all duration-300 border border-gray-200">
                            <i class="fas fa-users w-6 mr-4 text-center text-green-600"></i> Utilisateurs
                        </a>
                        <a href="<?php echo e(localized_route('admin.transactions')); ?>" class="flex items-center px-4 py-4 text-base font-medium text-gray-700 hover:text-purple-600 hover:bg-gray-50 rounded-xl transition-all duration-300 border border-gray-200">
                            <i class="fas fa-exchange-alt w-6 mr-4 text-center text-purple-600"></i> Virements
                        </a>
                        <a href="<?php echo e(localized_route('admin.deposit')); ?>" class="flex items-center px-4 py-4 text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-xl transition-all duration-300 border border-gray-200">
                            <i class="fas fa-plus-circle w-6 mr-4 text-center text-indigo-600"></i> Dépôt
                        </a>
                        <a href="<?php echo e(localized_route('admin.settings')); ?>" class="flex items-center px-4 py-4 text-base font-medium text-gray-700 hover:text-gray-600 hover:bg-gray-50 rounded-xl transition-all duration-300 border border-gray-200">
                            <i class="fas fa-cog w-6 mr-4 text-center text-gray-600"></i> Paramètres
                        </a>
                        <a href="<?php echo e(localized_route('dashboard', ['locale' => app()->getLocale()])); ?>" class="flex items-center px-4 py-4 text-base font-medium text-gray-700 hover:text-emerald-600 hover:bg-gray-50 rounded-xl transition-all duration-300 border border-gray-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerveau\resources\views\layouts\admin.blade.php ENDPATH**/ ?>