            ...
            <div class="relative z-10">
              <div class="flex items-start justify-between gap-4 mb-8">
                ...
                <div class="rounded-2xl bg-slate-900 text-white px-4 py-3 shadow-lg min-w-[138px]">
                  <p class="text-[11px] uppercase tracking-[0.25em] text-slate-400 mb-2"><?php echo e(__('home.dashboard_transfers_in_progress')); ?></p>
              ...
              <div class="grid grid-cols-2 gap-4 mb-6">
                <div class="rounded-2xl border border-blue-100 bg-blue-50/80 p-5">
                  ...
                  <p class="text-sm font-semibold text-gray-900 mb-2"><?php echo e(__('home.feature_1_title')); ?></p>
                  <p class="text-sm text-gray-600 leading-relaxed"><?php echo e(__('home.feature_1_item_2')); ?></p>
                </div>
                ...
                <div class="rounded-2xl border border-emerald-100 bg-emerald-50/80 p-5">
                  ...
                  <p class="text-sm text-gray-600 leading-relaxed"><?php echo e(__('home.hero_feature_4')); ?></p>
                </div>
              </div>
              ...
              <div class="rounded-[1.75rem] bg-slate-950 text-white p-6 shadow-2xl">
                <div class="flex items-start justify-between gap-4 mb-5">
                  <div>
                    <p class="text-xs uppercase tracking-[0.3em] text-orange-300 mb-2"><?php echo e(__('home.dashboard_priority_transfer')); ?></p>
                    <h4 class="text-2xl font-semibold"><?php echo e(__('home.feature_3_title')); ?></h4>
                  </div>
                ...
                <p class="text-sm text-slate-300 mb-5"><?php echo e(__('home.dashboard_step')); ?></p>

                <div class="grid grid-cols-3 gap-3">
                  <div class="rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
                    <p class="text-xs uppercase tracking-[0.2em] text-slate-500 mb-2">01</p>
                    <p class="font-semibold"><?php echo e(__('transactions.step_information')); ?></p>
                    <p class="text-xs text-slate-400 mt-2"><?php echo e(__('home.hero_feature_1')); ?></p>
                  </div>
                  <div class="rounded-2xl border border-orange-300/30 bg-orange-400/10 px-4 py-4 shadow-lg shadow-orange-500/10">
                    ...
                    <p class="font-semibold"><?php echo e(__('transactions.step_processing')); ?></p>
                    <p class="text-xs text-slate-300 mt-2"><?php echo e(__('home.hero_feature_2')); ?></p>
                  </div>
                  <div class="rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
                    <p class="text-xs uppercase tracking-[0.2em] text-slate-500 mb-2">03</p>
                    <p class="font-semibold"><?php echo e(__('transactions.step_confirmation')); ?></p>
                    <p class="text-xs text-slate-400 mt-2"><?php echo e(__('home.hero_feature_4')); ?></p>
                  </div>
                </div>
              </div>
              ...
              <div class="grid grid-cols-3 gap-4 mt-6 text-center">
                <div class="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm">
                  <p class="text-gray-500 mb-2 text-sm"><?php echo e(__('home.dashboard_transfers')); ?></p>
                  <p class="font-bold text-premium text-2xl">+32</p>
                </div>
                <div class="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm">
                  <p class="text-gray-500 mb-2 text-sm"><?php echo e(__('home.dashboard_reception')); ?></p>
                  <p class="font-bold text-emerald-600 text-2xl">+18</p>
                </div>
                <div class="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm">
                  <p class="text-gray-500 mb-2 text-sm"><?php echo e(__('home.dashboard_alerts')); ?></p>
              ...
              <div class="grid grid-cols-2 gap-4 mt-6">
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <p class="text-xs uppercase tracking-[0.25em] text-slate-400 mb-3"><?php echo e(__('home.feature_2_title')); ?></p>
                  <p class="text-sm text-gray-600 leading-relaxed"><?php echo e(__('home.feature_2_description')); ?></p>
                </div>
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <p class="text-xs uppercase tracking-[0.25em] text-slate-400 mb-3"><?php echo e(__('home.advantage_4_title')); ?></p>
