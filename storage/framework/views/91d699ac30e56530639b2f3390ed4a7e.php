    ...
    <div class="bg-black bg-opacity-70 py-20 relative z-10">
      <div class="max-w-7xl mx-auto px-6 grid gap-12 items-center fade-in-up lg:grid-cols-[0.86fr,1.14fr] lg:gap-10 xl:grid-cols-[0.82fr,1.18fr] xl:gap-14">
        ...
        <div class="hidden lg:block">
          <div class="premium-card home-dashboard-shell home-dashboard-float rounded-[2.4rem] p-4 xl:p-5 relative overflow-hidden">
            <div class="absolute -top-14 right-0 h-48 w-48 rounded-full bg-blue-100/80 blur-3xl"></div>
            <div class="absolute -bottom-20 -left-8 h-52 w-52 rounded-full bg-orange-100/80 blur-3xl"></div>
            <div class="absolute inset-x-10 top-0 h-px bg-gradient-to-r from-transparent via-orange-300 to-transparent"></div>

            <div class="relative z-10 rounded-[2rem] border border-white/70 bg-white/85 shadow-[0_35px_90px_rgba(15,23,42,0.18)] overflow-hidden">
              <div class="flex items-center justify-between gap-5 border-b border-slate-200/80 bg-white/90 px-6 py-3 backdrop-blur-xl">
              ...
              <div class="grid grid-cols-[0.88fr,1.12fr] min-h-[31rem] xl:grid-cols-[0.84fr,1.16fr]">
                <div class="bg-gradient-to-b from-slate-950 via-slate-900 to-blue-950 px-5 py-5 text-white">
                  <div class="rounded-[1.8rem] border border-white/10 bg-gradient-to-br from-blue-600 via-indigo-600 to-slate-950 p-5 shadow-2xl home-dashboard-sweep">
                    ...
                    <div class="mt-5 grid grid-cols-[minmax(0,1fr),112px] gap-4 items-end">
                      <div>
                        <p class="text-[11px] uppercase tracking-[0.25em] text-blue-100/60">IBAN</p>
                        <div class="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1 text-[15px] font-semibold tracking-[0.16em] text-white/95">
                          <span>FR76</span>
                          <span>&bull;&bull;</span>
                          <span>4587</span>
                          <span>&bull;&bull;</span>
                ...
                <div class="bg-[linear-gradient(180deg,rgba(248,250,252,0.98),rgba(255,255,255,0.92))] px-5 py-5">
                  ...
                  <div class="rounded-[1.8rem] bg-slate-950 p-4 text-white shadow-2xl home-dashboard-sweep">
                    ...
                    <div class="mb-4 h-3 w-full overflow-hidden rounded-full bg-white/10">
                  ...
                  <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="rounded-[1.45rem] border border-blue-100 bg-blue-50/80 p-4">
