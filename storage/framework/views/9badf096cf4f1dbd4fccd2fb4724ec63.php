                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <a href="<?php echo e(route('home')); ?>" class="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">SG BANK</a>
                        ...
                        <div class="hidden md:flex items-center space-x-6">
                            <div class="flex items-center space-x-3 bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-2 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gray-600">Compte N° <?php echo e($user->id); ?></div>
                                </div>
                            </div>
                            <a href="<?php echo e(route('dashboard')); ?>" class="text-blue-600 hover:text-blue-700 font-medium flex items-center gap-2">
                    ...
                    <div id="mobile-menu" class="hidden pb-4">
                        <div class="px-2 pt-2 pb-3 space-y-2 bg-white/95 backdrop-blur-lg border border-gray-200 rounded-lg shadow-xl mt-2">
                            ...
                            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center w-full px-3 py-2 text-base font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition duration-300">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="px-8 py-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></p>
                                    </div>
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->email); ?></p>
                                    </div>
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->phone); ?></p>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->date_of_birth ? $user->date_of_birth->format('d/m/Y') : 'Non spécifiée'); ?></p>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->address); ?></p>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->city); ?></p>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->country); ?></p>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->id_type); ?></p>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($user->id_number); ?></p>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $user->transactions()->latest()->take(3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition duration-200">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <div class="text-sm font-semibold text-gray-900 capitalize"><?php echo e($transaction->type); ?></div>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="space-y-4">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="text-sm font-bold text-gray-900"><?php echo e($user->id); ?></span>
                                        </div>
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="text-sm font-bold text-gray-900"><?php echo e($user->created_at->format('d/m/Y')); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="text-sm font-bold text-gray-900"><?php echo e($user->iban); ?></span>
                                        </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="text-sm font-bold text-gray-900"><?php echo e($user->bic); ?></span>
                                        </div>
                                        <?php endif; ?>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="space-y-4 text-gray-900">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="text-sm font-bold"><?php echo e($user->creditCard->card_holder_name); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="font-semibold text-sm text-gray-600">Numéro de carte</span>
                                            <span class="text-sm font-bold"><?php echo e($user->creditCard->masked_card_number); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="font-semibold text-sm text-gray-600">Type de carte</span>
                                            <span class="text-sm font-bold"><?php echo e($user->creditCard->card_type ?? 'Non spécifié'); ?></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="font-semibold text-sm text-gray-600">Date d'expiration</span>
                                            <span class="text-sm font-bold"><?php echo e($user->creditCard->expiry_date->format('m/Y')); ?></span>
                                        </div>
                                    </div>
                                    <?php else: ?>
                        ...
                        <div class="glass-card rounded-2xl overflow-hidden card-hover stagger-item">
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <a href="<?php echo e(route('transfer.create')); ?>" class="action-btn bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-4 rounded-xl hover:from-blue-600 hover:to-indigo-700 text-center transition duration-300 transform hover:scale-105 shadow-lg block">
                                    ...
                                    <a href="<?php echo e(route('transactions.history')); ?>" class="action-btn bg-gradient-to-r from-gray-600 to-gray-700 text-white p-4 rounded-xl hover:from-gray-700 hover:to-gray-800 text-center transition duration-300 transform hover:scale-105 shadow-lg block">
                                        <div class="bg-white/20 p-2 rounded-full w-10 h-10 flex items-center justify-center mx-auto mb-2">
