                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <a href="<?php echo e(localized_route('home', ['locale' => app()->getLocale()])); ?>" class="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"><span class="sr-only">SG BANK</span></a>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="badge <?php if($user->two_factor_enabled): ?> bg-green-100 text-green-800 <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                                ...
                                                <?php echo e($user->two_factor_enabled ? 'Activ??e' : 'D??sactiv??e'); ?>
                        ...
                        <div class="glass-card rounded-2xl overflow-hidden card-hover stagger-item">
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <a href="<?php echo e(localized_route('transfer.create', ['locale' => app()->getLocale()])); ?>" class="action-btn bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-4 rounded-xl hover:from-blue-600 hover:to-indigo-700 text-center transition duration-300 transform hover:scale-105 shadow-lg block">
