...
<body>
    ...
    <div class="content">
        ...
        <p>Bonjour <strong><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></strong>,</p>
        ...
        <div style="background: #e0f2fe; border: 1px solid #0ea5e9; color: #0c4a6e; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <strong>💡 Conseil :</strong> Utilisez l'adresse email <strong><?php echo e($user->email); ?></strong> et le mot de passe que vous avez choisi lors de votre inscription pour vous connecter.
        </div>
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\emails\user_approved_notification.blade.php ENDPATH**/ ?>