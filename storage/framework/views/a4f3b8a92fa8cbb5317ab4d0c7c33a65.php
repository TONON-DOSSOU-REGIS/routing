        ...
        <div class="min-h-screen relative z-10">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden md:flex items-center space-x-6">
                            ...
                            <a href="<?php echo e(localized_route('transfer.create', ['locale' => app()->getLocale()])); ?>" class="action-btn bg-gradient-to-r from-orange-500 to-amber-500 text-white px-4 py-2 rounded-xl hover:from-orange-600 hover:to-amber-600 font-medium shadow-lg transition duration-300 flex items-center gap-2">
            ...
            <div class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div class="mb-8 fade-in-up">
                    <h1 class="text-2xl sm:text-3xl font-bold text-white drop-shadow-lg text-center"><?php echo e(__('transactions.history_title')); ?></h1>
                                                ...
                                                <td class="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                                    <div class="flex items-center gap-3">
                                                        <div class="transaction-icon 
                                                            <?php if($transaction->type == 'transfer'): ?> bg-blue-100 text-blue-600
                                                            <?php elseif($transaction->type == 'deposit'): ?> bg-green-100 text-green-600
                                                ...
                                                <td class="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                                        <div class="progress-fill 
                                                            <?php if($transaction->progress >= 100): ?> bg-green-500
                                                            <?php elseif($transaction->progress >= 70): ?> bg-blue-500
                                                            <?php elseif($transaction->progress >= 30): ?> bg-yellow-500
                                                            <?php else: ?> bg-red-500 <?php endif; ?>" 
                                                            style="width: <?php echo e($transaction->progress); ?>%">
                                                        </div>
                                                    </div>
                                                    <div class="text-xs text-gray-500 text-center mt-1">
                                                        <?php echo e($transaction->progress); ?>%
                                                    </div>
                                                </td>
                                                <td class="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\transactions\history.blade.php ENDPATH**/ ?>