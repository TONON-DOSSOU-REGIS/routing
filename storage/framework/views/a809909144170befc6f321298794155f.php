<?php $__env->startSection('title', __('auth.reset_password_title')); ?>
<?php $__env->startSection('auth_nav_subtitle', 'Secure password reset'); ?>
...
<?php $__env->startSection('auth_hero'); ?>
    ...
    <h1 class="auth-heading mt-6 text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl">
        <?php echo e(__('auth.reset_password_title')); ?>

    </h1>
    <p class="mt-4 max-w-2xl text-base leading-7 text-white/76 sm:text-lg">
        <?php echo e(__('auth.reset_password_subtitle')); ?>
    ...
    <div class="mt-10 space-y-3">
        <div class="auth-chip">
            ...
            <span class="text-sm font-semibold"><?php echo e(__('auth.new_password')); ?></span>
        </div>
        <div class="auth-chip">
...
<?php $__env->startSection('auth_panel'); ?>
    <div class="flex items-start justify-between gap-4">
        <div>
            ...
            <h2 class="auth-heading mt-2 text-3xl font-semibold tracking-[-0.04em] text-slate-950"><?php echo e(__('auth.reset_password_title')); ?></h2>
            <p class="mt-2 text-sm leading-6 text-slate-500"><?php echo e(__('auth.reset_password_subtitle')); ?></p>
        </div>
    ...
    <form method="POST" action="<?php echo e(route('password.update', ['locale' => app()->getLocale()])); ?>" class="mt-6 space-y-5">
        <?php echo csrf_field(); ?>
        ...
        <div>
            <label for="password" class="mb-2 block text-xs font-semibold uppercase tracking-[0.16em] text-slate-400"><?php echo e(__('auth.new_password')); ?></label>
            <div class="relative">
                <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400">
        ...
        <div>
            <label for="password-confirm" class="mb-2 block text-xs font-semibold uppercase tracking-[0.16em] text-slate-400"><?php echo e(__('auth.confirm_new_password')); ?></label>
            <div class="relative">
                <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400">
                    <i class="fas fa-lock text-sm"></i>
                </span>
...
<?php echo $__env->make('layouts.auth-premium', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerveau\resources\views\auth\passwords\reset.blade.php ENDPATH**/ ?>