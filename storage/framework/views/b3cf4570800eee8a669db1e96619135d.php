...
<head>
    ...
    <title><?php echo e(__("services.business_page_title")); ?></title>
...
<!-- Navigation -->
        ...
        <div class="support-hero-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto fade-in-up">
                <h1 class="text-4xl sm:text-5xl font-bold mb-6">
                    <?php echo e(__("services.business_hero_title")); ?>

                </h1>
                <p class="text-xl mb-8 text-blue-100 leading-relaxed">
                    <?php echo e(__("services.business_hero_desc")); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(localized_route('register', ['locale' => app()->getLocale()])); ?>" class="btn-premium px-8 py-4 rounded-lg font-semibold text-center">
                        <?php echo e(__("services.business_hero_cta_primary")); ?>
                    ...
                    <a href="#features" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-900 transition text-center">
                        <?php echo e(__("services.business_hero_cta_secondary")); ?>
    ...
    <section id="features" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-4xl font-bold mb-6 text-premium"><?php echo e(__("services.business_features_title")); ?></h2>
                <p class="text-xl text-gray-600 leading-relaxed">
                    <?php echo e(__("services.business_features_desc")); ?>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.business_f1_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.business_f1_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.business_f2_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.business_f2_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.business_f3_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.business_f3_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.business_f4_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.business_f4_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.business_f5_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.business_f5_desc")); ?>
                ...
                <div class="premium-card rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-semibold mb-4 text-premium"><?php echo e(__("services.business_f6_title")); ?></h3>
                    <p class="text-gray-600 leading-relaxed">
                        <?php echo e(__("services.business_f6_desc")); ?>
    ...
    <section class="py-24 bg-gradient-to-r from-blue-900 to-blue-800 text-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl font-bold mb-6"><?php echo e(__("services.business_cta_title")); ?></h2>
            <p class="text-xl mb-8 text-blue-100 leading-relaxed">
                <?php echo e(__("services.business_cta_desc")); ?>
            ...
            <a href="<?php echo e(localized_route('register', ['locale' => app()->getLocale()])); ?>" class="btn-premium px-12 py-5 rounded-lg text-2xl font-bold inline-block">
                <?php echo e(__("services.business_cta_btn")); ?>
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\services\comptes-professionnels.blade.php ENDPATH**/ ?>