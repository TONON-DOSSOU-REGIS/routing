...
<body>
    ...
    <div class="content">
        ...
        <p>Bonjour <strong><?php echo e($transaction->user->first_name); ?> <?php echo e($transaction->user->last_name); ?></strong>,</p>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <span class="value"><strong><?php echo e(number_format($transaction->amount, 2, ',', ' ')); ?> €</strong></span>
            </div>
            ...
            <div class="info-row">
                ...
                <span class="value"><?php echo e(now()->format('d/m/Y à H:i')); ?></span>
            </div>
            
            <?php if($refundReason): ?>
            <div class="info-row">
                <span class="label">Motif du remboursement:</span>
                <span class="value"><?php echo e($refundReason); ?></span>
            </div>
            <?php endif; ?>
        </div>
        
        <div class="alert-success">
            <strong>✅ Fonds crédités:</strong> Le montant de <?php echo e(number_format($transaction->amount, 2, ',', ' ')); ?> € a été recrédité sur votre compte.
        </div>
    ...
    <div class="footer">
        ...
        <p>© <?php echo e(date('Y')); ?> SG BANK. Tous droits réservés.</p>
    </div>
</body>
</html>


<?php /**PATH C:\xampp\htdocs\cerveau\resources\views/emails/transaction_refunded.blade.php ENDPATH**/ ?>