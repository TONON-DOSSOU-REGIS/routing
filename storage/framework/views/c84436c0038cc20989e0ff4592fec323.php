...
const adminChatI18n = <?php echo json_encode($adminChatFixedI18n, 15, 512) ?>;
...
<div id="admin-chat-image-modal" class="hidden fixed inset-0 z-[9999] bg-black/80 flex items-center justify-center p-4">
    ...
    <img id="admin-chat-image-full" src="" alt="<?php echo e(__('chat.image_preview_alt')); ?>" class="max-h-[90vh] max-w-[90vw] rounded-lg shadow-2xl cursor-grab" style="transform: translate(0,0) scale(1);">
</div>

<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\components\admin-chat-widget-fixed.blade.php ENDPATH**/ ?>