...
<body>
    <div class="email-container">
        ...
        <!-- Contenu principal -->
        <div class="content">
            <h1 class="greeting">Bonjour <?php echo e($contact->first_name); ?>,</h1>
            ...
            <div class="details-card">
                ...
                <ul class="details-list">
                    <li>
                        ...
                        <span class="detail-value"><?php echo e($contact->first_name); ?> <?php echo e($contact->last_name); ?></span>
                    </li>
                    <li>
                        <span class="detail-label">Email :</span>
                        <span class="detail-value"><?php echo e($contact->email); ?></span>
                    </li>
                    <li>
                        <span class="detail-label">Téléphone :</span>
                        <span class="detail-value"><?php echo e($contact->phone ?? 'Non fourni'); ?></span>
                    </li>
                    <li>
                        <span class="detail-label">Sujet :</span>
                        <span class="detail-value"><?php echo e($contact->subject); ?></span>
                    </li>
                </ul>
        ...
        <div class="footer">
            ...
            <p class="copyright">
                ...
                Cet email a été envoyé à <?php echo e($contact->email); ?>
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\emails\contact_confirmation.blade.php ENDPATH**/ ?>