...
<head>
    ...
    <title><?php echo e(__('about.our_story_title')); ?> - Valtrix Bank</title>
        ...
        <div class="support-hero-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto fade-in-up">
                <h1 class="text-4xl sm:text-5xl font-bold mb-6">
                    <?php echo e(__('about.our_story_hero_title')); ?>

                </h1>
                <p class="text-xl mb-8 text-blue-100 leading-relaxed">
                    <?php echo e(__('about.our_story_hero_description')); ?>
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\about\notre-histoire.blade.php ENDPATH**/ ?>