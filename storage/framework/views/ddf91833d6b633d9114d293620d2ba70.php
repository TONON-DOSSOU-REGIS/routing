            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <a href="<?php echo e(localized_route('admin.dashboard')); ?>" class="flex items-center text-xl font-bold text-gray-900">
                    ...
                    <div class="hidden md:flex items-center space-x-6">
                        <a href="<?php echo e(localized_route('admin.dashboard')); ?>" class="nav-link text-gray-600 hover:text-gray-900">Dashboard</a>
                        <a href="<?php echo e(localized_route('admin.settings')); ?>" class="nav-link text-gray-600 hover:text-gray-900">Paramètres</a>
                        <a href="<?php echo e(localized_route('admin.users')); ?>" class="nav-link text-gray-600 hover:text-gray-900 active">Utilisateurs</a>
                        <a href="<?php echo e(localized_route('admin.deposit')); ?>" class="nav-link text-gray-600 hover:text-gray-900">Dépôt</a>
                        <a href="<?php echo e(localized_route('dashboard', ['locale' => app()->getLocale()])); ?>" class="nav-link text-gray-600 hover:text-gray-900">Retour au site</a>
                ...
                <div class="md:hidden hidden" id="mobile-menu">
                    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 glass-effect border-t border-gray-200 rounded-b-lg">
                        <a href="<?php echo e(localized_route('admin.dashboard')); ?>" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors">Dashboard</a>
                        <a href="<?php echo e(localized_route('admin.settings')); ?>" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors">Paramètres</a>
                        <a href="<?php echo e(localized_route('admin.users')); ?>" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors">Utilisateurs</a>
                        <a href="<?php echo e(localized_route('admin.deposit')); ?>" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors">Dépôt</a>
                        <a href="<?php echo e(localized_route('dashboard', ['locale' => app()->getLocale()])); ?>" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors">Retour au site</a>
                        <form method="POST" action="<?php echo e(localized_route('logout', ['locale' => app()->getLocale()])); ?>" class="block px-3 py-2">
                            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div class="flex items-center mb-4 md:mb-0">
                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-1">
                                ...
                                <span class="status-badge <?php echo e($user->status == 'active' ? 'bg-success-100 text-success-800' : 'bg-danger-100 text-danger-800'); ?>">
                    ...
                    <div class="flex space-x-3">
                        <a href="<?php echo e(localized_route('admin.users')); ?>" class="flex items-center glass-effect text-gray-700 px-4 py-2 rounded-lg hover:bg-white/70 shadow-sm transition-all border border-gray-200/50">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="date"
                                               name="date_naissance"
                                               id="date_naissance"
                                               value="<?php echo e(old('date_naissance', $user->date_of_birth ? $user->date_of_birth->format('Y-m-d') : '')); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors bg-white/80">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="role"
                                                ...
                                                class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors bg-white/80"
                                                required>
                                            <option value="user" <?php echo e(old('role', $user->role) == 'user' ? 'selected' : ''); ?>>Client</option>
                                        ...
                                        <div class="flex items-center gap-4">
                                            <div class="h-14 w-14 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-semibold overflow-hidden">
                                                <?php if($user->profile_photo_url): ?>
                                                    <img src="<?php echo e($user->profile_photo_url); ?>" alt="Photo de <?php echo e($user->first_name); ?>" class="h-full w-full object-cover">
                                                <?php else: ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text"
                                               name="adresse"
                                               id="adresse"
                                               value="<?php echo e(old('adresse', $user->address)); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors bg-white/80">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                               name="ville"
                                               id="ville"
                                               value="<?php echo e(old('ville', $user->city)); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors bg-white/80">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="pays"
                                            ...
                                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($country['name']); ?>" <?php echo e(old('pays', $user->country) == $country['name'] ? 'selected' : ''); ?>>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select name="type_piece"
                                            ...
                                            <option value="CNI" <?php echo e(old('type_piece', $user->type_piece) == 'CNI' ? 'selected' : ''); ?>>Carte Nationale d'Identité</option>
                                            <option value="Passeport" <?php echo e(old('type_piece', $user->type_piece) == 'Passeport' ? 'selected' : ''); ?>>Passeport</option>
                                            <option value="Permis" <?php echo e(old('type_piece', $user->type_piece) == 'Permis' ? 'selected' : ''); ?>>Permis de conduire</option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                               name="numero_piece"
                                               id="numero_piece"
                                               value="<?php echo e(old('numero_piece', $user->numero_piece)); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors bg-white/80">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text"
                                               name="iban"
                                               id="iban"
                                               value="<?php echo e(old('iban', $user->iban)); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors bg-white/80"
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                               name="bic"
                                               id="bic"
                                               value="<?php echo e(old('bic', $user->bic)); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors bg-white/80"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text"
                                               ...
                                               id="card_holder_name"
                                               value="<?php echo e(old('card_holder_name', optional($user->creditCard)->card_holder_name)); ?>"
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                               name="card_number"
                                               id="card_number"
                                               value="<?php echo e(old('card_number', optional($user->creditCard)->card_number)); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-colors bg-white/80"
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                               name="card_type"
                                               id="card_type"
                                               value="<?php echo e(old('card_type', optional($user->creditCard)->card_type)); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-colors bg-white/80"
                                    ...
                                    <div>
                                        ...
                                        <input type="date"
                                               name="expiry_date"
                                               id="expiry_date"
value="<?php echo e(old('expiry_date', optional(optional($user->creditCard)->expiry_date)->format('Y-m-d'))); ?>"
                                               class="form-input block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-colors bg-white/80"
                    ...
                    <div class="space-y-6">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="activation_code"
                                                   value="<?php echo e(old('activation_code', $user->activation_code)); ?>"
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="active" <?php echo e(old('status', $user->status) == 'active' ? 'selected' : ''); ?>>Actif</option>
                                        <option value="suspended" <?php echo e(old('status', $user->status) == 'suspended' ? 'selected' : ''); ?>>Suspendu</option>
                                    </select>
                                </div>
                                <div class="text-sm text-warning-700">
                                    <p class="flex items-center"><strong class="mr-2">Statut actuel :</strong>
                                        <span class="status-badge <?php echo e($user->status == 'active' ? 'bg-success-100 text-success-800' : 'bg-danger-100 text-danger-800'); ?>">
                                            <i class="fas <?php echo e($user->status == 'active' ? 'fa-check-circle' : 'fa-ban'); ?> mr-1"></i>
                                            <?php echo e(ucfirst($user->status)); ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           name="balance"
                                           id="balance"
                                           value="<?php echo e(old('balance', number_format($user->balance, 2, ',', ''))); ?>"
                                    ...
                                    <p class="mt-1 text-xs text-green-600">
                                        <i class="fas fa-info-circle mr-1"></i> Solde actuel: <?php echo e(number_format($user->balance, 2)); ?> €. Cette modification sera tracée.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-effect rounded-xl p-5 shadow-soft border border-gray-200/50">
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="<?php echo e(localized_route('admin.users')); ?>" class="w-full flex justify-center items-center bg-gray-200/80 text-gray-700 px-4 py-3 rounded-lg hover:bg-gray-300/80 transition-colors">
            ...
            <div class="mt-8 glass-effect border border-danger-200/50 rounded-xl p-5 shadow-soft">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <form method="POST" action="<?php echo e(localized_route('admin.users.reset-password', $user)); ?>" class="md:ml-4">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\cerveau\resources\views\admin\users\edit.blade.php ENDPATH**/ ?>