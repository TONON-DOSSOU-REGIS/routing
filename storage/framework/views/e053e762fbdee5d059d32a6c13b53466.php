      ...
      <section class="mb-8 fade-in-up">
        <div class="bg-gradient-to-r from-white via-blue-50/30 to-indigo-50/30 rounded-2xl shadow-lg border border-white/60 px-4 sm:px-6 py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between backdrop-blur-sm">
          <div class="flex items-center gap-4 flex-wrap sm:flex-nowrap">
            ...
            <div class="h-12 w-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-semibold overflow-hidden shadow">
              <?php if($profilePhotoUrl): ?>
                <img src="<?php echo e($profilePhotoUrl); ?>" alt="Photo de <?php echo e($displayName); ?>" class="h-full w-full object-cover">
              <?php else: ?>
          ...
          <div class="flex flex-col sm:flex-row sm:items-center gap-2 mt-4 sm:mt-0 w-full sm:w-auto">
            <a href="<?php echo e(localized_route('transfer.create', ['locale' => app()->getLocale()])); ?>" class="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-orange-500 text-white hover:bg-orange-600 card-hover w-full sm:w-auto">
              <i class="fa-solid fa-paper-plane mr-2"></i> <?php echo e(__('dashboard.new_transfer')); ?>

            </a>
            <a href="<?php echo e(localized_route('transactions.history', ['locale' => app()->getLocale()])); ?>" class="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-slate-100 text-slate-800 hover:bg-slate-200 card-hover w-full sm:w-auto">
      ...
      <section class="grid grid-cols-1 lg:grid-cols-3 gap-6 fade-in-up">
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div class="space-y-3">
              <a href="<?php echo e(localized_route('transfer.create', ['locale' => app()->getLocale()])); ?>" class="block action-btn bg-gradient-to-r from-orange-500 to-amber-500 text-white p-4 rounded-xl hover:from-orange-600 hover:to-amber-600 transition card-hover">
