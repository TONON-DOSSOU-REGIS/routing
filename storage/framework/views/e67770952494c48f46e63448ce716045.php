...
<head>
    ...
    <title>Nouvelle inscription - SG BANK</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <p>Un nouvel utilisateur vient de s'inscrire sur SG BANK et attend votre validation pour accéder à son compte.</p>
    ...
    <div class="footer">
        <p>Cet email a été envoyé automatiquement par SG BANK.</p>
